<?php exit;?>001550565784c452307dfc84673d0534cf9374424858s:6654:"a:2:{s:8:"template";s:6590:"<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
			...
			<div class="headNum" id="headerData">
				...
				<div class="divline drawCodel tiger">
					<ul class="pk10li longhu">
						...
						<li class="guanyaheli li_after">金</li>
					</ul>
				</div>
...
<!--					<div id="haomafb"><span>号码分布<i></i></span></div>-->
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/bjkl8Video/azxy20_index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/bjkl8/head_aozxy20.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/bjkl8/index.js"></script>
		<script type="text/javascript" src="/themes/m/js/lib/GA.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>
";s:12:"compile_time";i:1519029784;}";