<?php exit;?>0015503966646d6d2aeeb05f1923d5730fa342ce48fcs:5278:"a:2:{s:8:"template";s:5214:"<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		<div class="pagediv">
			...
			<div class="headNum headNumSm" id="headerData">
				<div class="divline issuel">
					...
					<span class="drawCount">每周一、三、五21:30:00开奖</span>
				</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/qgc/fc7lc_kaijiang.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/qgc/fcssq_index.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>
";s:12:"compile_time";i:1518860664;}";