<?php exit;?>00155039670226fe86c02d988441f3490f8d4a1996c4s:5240:"a:2:{s:8:"template";s:5176:"<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		<div class="pagediv">
			...
			<div class="headNum headNumSm" id="headerData">
				<div class="divline issuel">
					...
					<span class="drawCount">每周二、五、日20:30:00开奖</span>
				</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/qgc/tc7xc_kaijiang.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/qgc/tc7xc_index.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>
";s:12:"compile_time";i:1518860702;}";