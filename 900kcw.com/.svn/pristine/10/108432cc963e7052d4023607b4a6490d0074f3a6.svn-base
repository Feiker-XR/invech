<?php exit;?>001548311057b349a059ccfc2ab44338e82fcf6f9c53s:5015:"a:2:{s:8:"template";s:4951:"<form method="post" class="form-x dux-form form-auto" id="form" action="<?php echo url('site');?>">
    <div class="panel dux-box  active">
        ...
        <div class="panel-body">
         ...
         <div class="form-group">
                <div class="label">
                    <label for="sitename">开奖接口</label>
                </div>
                <div class="field">
                    <input type="text" class="input" id="site_statistics" name="site_statistics" size="60" value="<?php echo $info["site_statistics"];?>">
                    <div class="input-note">用于采集开奖结果</div>
                </div>
            </div>
...
//--></SCRIPT>";s:12:"compile_time";i:1516775057;}";