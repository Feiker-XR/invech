...
function listData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/lottery/pk10_double_count",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function forRank(data) {
	...
	//$("#lmsjtable").empty();
	//		
	var tablehead = "<tr height='50' class='mc1'><th  width='400'>日期</th><th width='300'>单</th><th width='300'>双</th><th width='300'>大</th><th width='300'>小</th></tr>";
	$("#lmsjtable>thead").empty(); //清空表头
	$("#lmsjtable>tbody").empty();
