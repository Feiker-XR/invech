<?php exit;?>001550395613ab496736880023246f815196977457dcs:6541:"a:2:{s:8:"template";s:6477:"<!DOCTYPE html>
<html>
		...
		<div class="pagediv">
			...
			<div class="headNum" id="headerData">
				...
				<div class="divline drawCodel">
					<ul id="pk10num" class="cqnclilist numberbox">
						<li>03</li>
						<li>01</li>
						<li>05</li>
						<li>06</li>
...
<?php $__Template->display("themes/m/foot"); ?>
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/cqnc_video/index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/xync/head_cqnc.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/xync/index.js"></script>
		<script type="text/javascript"src="/themes/m/js/lib/GA.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>
";s:12:"compile_time";i:1518859613;}";