<?php exit;?>00154978303522aed5177e9c5cc6fa7b9bfa433c592cs:1935:"a:2:{s:8:"template";s:1871:"<script type="text/javascript">var publicUrl = "<?php echo $sys["site_statistics"];?>/";</script>
...
<script>
	$(function() {
		...
		/*$("#indexHeader .top_menu_left").on("touchstart", "img", function() {
			...
			</div>";s:12:"compile_time";i:1518247035;}";