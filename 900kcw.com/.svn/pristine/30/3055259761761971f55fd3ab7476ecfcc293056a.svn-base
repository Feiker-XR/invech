<?php exit;?>00154869381091ee767e848515e1a76f70ed02a6eb51s:1836:"a:2:{s:8:"template";s:1772:"<div id="" class="indexContainer withHeader">
...
<script>
	$(function() {
		...
		/*$("#indexHeader .top_menu_left").on("touchstart", "img", function() {
			...
			</div>";s:12:"compile_time";i:1517157810;}";