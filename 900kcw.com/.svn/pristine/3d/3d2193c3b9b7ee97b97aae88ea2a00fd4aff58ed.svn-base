...
function listData(date) {
	...
	$.ajax({
		url: "https://api.api68.com/CQShiCai/getBaseCQShiCaiList.do?lotCode=10002&" + date,
		// url: "http://www.900kcw.com/?r=home/history/cqssc",
		type: "GET",
		// data: {
		// 	"lotCode": lotCode
		// },
...
function longData() {
	$.ajax({
		url: urlbublic + "CQShiCai/getShiCaiDailyDragonCount.php",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
