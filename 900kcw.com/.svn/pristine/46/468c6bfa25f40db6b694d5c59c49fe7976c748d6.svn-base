<?php exit;?>00155039667981be78c22bf96067fcdeacc8dfdd68a9s:5855:"a:2:{s:8:"template";s:5791:"
<!DOCTYPE html>
<html>
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		<div class="pagediv">
			...
			<div class="headNum headNumSm" id="headerData">
				<div class="divline issuel">
					...
					<span class="drawCount">每日20:30:00开奖</span>
				</div>
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/fc3DVideo/tcpl3_index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/qgc/tcpl3_kaijiang.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/qgc/fc3D_index.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>";s:12:"compile_time";i:1518860679;}";