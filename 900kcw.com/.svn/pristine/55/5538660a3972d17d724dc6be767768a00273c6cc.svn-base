...
$(function() {
...
}), $("#footerDiv").load("themes/m/foot.html", function() {
	...
	$(e).find(".cuttime").hide(), $(e).find(".opentyle").show(), intervalPk10 = setInterval(function() {
		...
		for (var r = "", o = 0; o < 10; o++) {
			...
			r += 9 == o ? "<li style='margin-right: 0px;' class='li_after " + l + "'></li>" : "<li class='" + l + "'></li>"
		}
		$(e).find(".numberbox").empty(), $(e).find(".numberbox").append(r)
	...
	var s = setInterval(function() {
		...
		if (a < i) {
			a == i - 1 && (t = "li_after");
			var r = "<li class='nub" + e[a] + " " + t + "'><i style='font-size:10px; display:none'>" + e[a] + "</i></li>";
			$(n).append(r), a += 1
	...
	$(e).find(".opentyle").show(), $(e).find(".cuttime").hide(), intervalSsc = setInterval(function() {
		...
		for (var i = 0, a = $(e).find(".numberbox li").length; i < a; i++) {
			...
			var s = 1 * n,
				r = tools.kuaicase(1 * tools.excutenum1_6() + 1);
	...
	$(".opening").show(), $(".clock").hide(), intervalSsc = setInterval(function() {
		...
		for (var r = "", o = 0; o < 10; o++) r += "<li class='ncnum0" + a[o] + "'></li>";
		$(i).empty(), $(i).append(r), 100 == t && $("#waringbox").show(300)
	}, 100), animateID[e] = intervalSsc
		...
		f = setInterval(function() {
			...
			if (u > 1) {
				...
				var a = Math.floor(u / 3600),
					...
					m = Math.floor(u % 60);
				$(n).text(a < 10 ? "0" + a : a), $(s).text(d < 10 ? "0" + d : d), $(r).text(m < 10 ? "0" + m : m), a <= 0 ? $(".hourid").hide() : $(".hourid").show()
			} else $(o).show(), $(l).hide(), clearInterval(f), method.indexLoad(i)
		}, 1e3)
}, tools.cutTimePercent = function(e, t, i) {
	var a = e.replace("-", "/"),
		t = t.replace("-", "/");
	a = a.replace("-", "/"), t = t.replace("-", "/");
	var n = $(i).find(".hour"),
	...
	var i = ["10001", "10012", "10037"],
		a = ["10002", "10003", "10004", "10010", "10036"],
		n = ["10005", "10011", "10034"],
		s = ["10009"],
		r = ["10007", "10026", "10027", "10028", "10029", "10030", "10031", "10032", "10033"],
...
var cZ = {
	...
	{
		name: "北京PK10",
		href: "/beijingsaichePK10.html"
	}, {
		name: "900PK10",
		href: "/900PK10.html"
	}, {
		name: "900时时彩",
		href: "/900shishicai.html"
	}, {
		name: "极速赛车",
		href: "/jisusaiche.html"
	}, {
		name: "极速时时彩",
		href: "/jisushishicai.html"
	}, {
		name: "重庆时时彩",
		href: "/zhongqingshishicai.html"
	}, {
		name: "新疆时时彩",
		href: "/xinjiangshishicai.html"
	}, {
		name: "天津时时彩",
		href: "/tianjinshishicai.html"
	},  {
		name: "江苏快3",
		href: "/jiangsukuai3.html"
	}, {
		name: "广东快乐十分",
		href: "/guangdongkuaileshifen.html"
	}, {
		name: "十一运夺金",
		href: "/shiyiyunduojin.html"
	}, {
		name: "广东11选5",
		href: "/guangdong11xuan5.html"
	}, {
		name: "幸运农场",
		href: "/xingyunnongchang.html"
	}, {
		name: "广西快乐十分",
		href: "/guangxikuailiaoshifen.html"
	}, {
		name: "PC蛋蛋幸运28",
		href: "/PCdandanxingyun28.html"
	}],
	toGPC: [{
		name: "天津快乐十分",
		href: "/tianjinkuaileshifen.html"
	}, {
		name: "上海11选5",
		href: "/shanghai11xuan5.html"
	}, {
		name: "安徽11选5",
		href: "/anhui11xuan5.html"
	}, {
		name: "江西11选5",
		href: "/jiangxi11xuan5.html"
	}, {
		name: "江苏11选5",
		href: "/jiangsu11xuan5.html"
	}, {
		name: "辽宁11选5",
		href: "/liaoning11xuan5.html"
	}, {
		name: "湖北11选5",
		href: "/hubei11xuan5.htmll"
	}, {
		name: "广西11选5",
		href: "/guangxi11xuan5.html"
	}, {
		name: "吉林11选5",
		href: "/jilin11xuan5.html"
	}, {
		name: "内蒙古11选5",
		href: "/neimenggu11xuan5.html"
	}, {
		name: "浙江11选5",
		href: "/zhejiang11xuan5.html"
	}, {
		name: "广西快3",
		href: "/guangxikuai3.html"
	}, {
		name: "吉林快3",
		href: "/jilinkuai3.html"
	}, {
		name: "河北快3",
		href: "/hebeikuai3.html"
	}, {
		name: "内蒙古快3",
		href: "/neimenggukuai3.html"
	}, {
		name: "安徽快3",
		href: "/anhuikuai3.html"
	}, {
		name: "福建快3",
		href: "/fujiankuai3.html"
	}, {
		name: "湖北快3",
		href: "/hubeikuai3.html"
	}, {
		name: "北京快3",
		href: "/beijingkuai3.html"
	}, {
		name: "北京快乐8",
		href: "/beijingkuaile8.html"
	}],
	toJWC: [{
		name: "澳洲幸运5",
		href: "aozhouxingyun5.html"
	}, {
		name: "澳洲幸运8",
		href: "aozhouxingyun8.html"
	}, {
		name: "澳洲幸运10",
		href: "aozhouxingyun10.html"
	}, {
		name: "澳洲幸运20",
		href: "aozhouxingyun20.html"
	}, {
		name: "台湾宾果",
		href: "/taiwanbg.html"
	},  {
	...
	toQGC: [{
		name: "福彩双色球",
		href: "/shuangseqiu.html"
	}, {
		name: "福彩3D",
		href: "/fucai3D.html"
	}, {
		name: "福彩七乐彩",
		href: "/fucaiqilecai.html"
	}, {
		name: "超级大乐透",
		href: "/chaojidaletou.html"
	}, {
		name: "体彩排列3",
		href: "/ticaipailie3.html"
	}, {
		name: "体彩排列5",
		href: "/ticaipailie5.html"
	}, {
		name: "体彩七星彩",
		href: "/ticaiqixingcai.html"
	}]
};
tools.openAllCz = function(e) {
	...
	pk10: function(e, t) {
		...
		if (0 == i.errorCode) {
			...
			animate.pk10AnimateEnd(r, t), setTimeout(function() {
	...
	ssc: function(e, t) {
		...
		if (0 == i.errorCode) {
			...
			var a = $(".longhu").find("li"),
				...
				s = i.dragonTiger;
			s = "0" == s ? "龙" : "1" == s ? "虎" : "2" == s ? "和" : "";
			for (var r = 0, o = a.length; r < o; r++) switch (r) {
			case 0:
	...
	bjkl8: function(e, t) {
		...
		if (0 == i.errorCode) {
			...
			$(".longhu").html(""), $(".longhu").append(a), $(t).find(".cuttime").css({
				...
				console.log(new Date(i.drawTime));

			}, 1e3), tools.cutTimePercent(i.drawTime, i.serverTime, t);
			var r = i.preDrawCode.split(",");
			animate.sscAnimateEnd(r, t), tools.bjkl8BagColor(r, t), $(t).find("#pk10num").find("li:last-child").css({
				background: "#FA8E19"
			}), setTimeout(function() {
				tools.ifToday() && method.loadOther("")
			}, 1e3), clearInterval(animateID[t]), delete animateID[t]
	...
	egxy28: function(e, t) {
		...
		if (0 == i.errorCode) {
			...
			var r = i.preDrawCode.split(",");
			r.push(i.sumNum), animate.sscAnimateEnd(r, t), $(t).find("#pk10num").find("li:last-child").css({
				background: "red"
			}), setTimeout(function() {
				tools.ifToday() && method.loadOther("")
			}, 1e3), clearInterval(animateID[t]), delete animateID[t]
	...
	jsk3: function(e, t) {
		...
		if (0 == i.errorCode) {
			...
			var r = i.preDrawCode.split(",");
			animate.kuai3AnimateEnd(r, t), setTimeout(function() {
				tools.ifToday() && method.loadOther("")
			}, 1e3), clearInterval(animateID[t]), delete animateID[t]
		}
	},
	...
	pk10: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "pks/getLotteryPksInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/pk10&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	pk10_900: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "pks/getLotteryPksInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/pk10_900&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	azxy10: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "pks/getLotteryPksInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/azxy10&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	jisusaiche: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "pks/getLotteryPksInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/jssc&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	ssc: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "CQShiCai/getBaseCQShiCai.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/cqssc&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	ssc_900: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "CQShiCai/getBaseCQShiCai.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/ssc_900&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	jsssc: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "CQShiCai/getBaseCQShiCai.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/jsssc&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	xjssc: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "CQShiCai/getBaseCQShiCai.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/xjssc&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	tjssc: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "CQShiCai/getBaseCQShiCai.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/tjssc&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	azxy5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "CQShiCai/getBaseCQShiCai.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/azxy5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	bjkl8: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "LuckTwenty/getBaseLuckTewnty.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/bjkl8&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	twbg: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "LuckTwenty/getBaseLuckTewnty.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/twbg&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	azxy20: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "LuckTwenty/getBaseLuckTewnty.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/azxy20&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	egxy28: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "LuckTwenty/getPcLucky28.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/pcddxy28&num=" + e,
			type: "GET",
			beforeSend: function() {
				$(t).find("#pk10num li").each(function() {
	...
	klsf: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "klsf/getLotteryInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/gdkl10f&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	tjkl10f: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "klsf/getLotteryInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/tjkl10f&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	gxklsf: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "gxklsf/getLotteryInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/gxkl10f&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	azxy8: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "gxklsf/getLotteryInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/azxy8&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	gd11x5: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/gd11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	syydj: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/syydj&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	sh11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/sh11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	js11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/js11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	ah11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/ah11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	jx11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/jx11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	ln11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/ln11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	hb11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/hb11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	gx11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/gx11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	jl11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/jl11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	nmg11x5: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/nmg11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	zj11x5: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "ElevenFive/getElevenFiveInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/zj11x5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	jsk3: function(e, t) {
		var e = void 0 == e ? "" : e,
			i = !1;
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/jsk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	gxk3: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/gxk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	jlk3: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/jlk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	hbk3: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/hbk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	nmgk3: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/nmgk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	ahk3: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/ahk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	fjk3: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/fjk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	bjk3: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/bjk3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	cqnc: function(e, t) {
		...
		$.ajax({
			// url: config.publicUrl + "klsf/getLotteryInfo.php?issue=" + e,
			url: "http://m.900kcw.com//?r=home/lottery/xync&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: lotCode
			// },
	...
	fcssq: function(e) {
		...
		config.ifdebug && console.log("obj：" + JSON.stringify(e)), $.ajax({
			url: "http://m.900kcw.com//?r=home/lottery/fcssq&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: a
			// },
	...
	fc3d: function(e) {
		var t = e.url,
			...
			n = !1;
		config.ifdebug && console.log("obj：" + JSON.stringify(e)), $.ajax({
			url: "http://m.900kcw.com//?r=home/lottery/fc3d&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: a
			// },
	...
	fc7lc: function(e) {
		var t = e.url,
			...
			n = !1;
		config.ifdebug && console.log("obj：" + JSON.stringify(e)), $.ajax({
			url: "http://m.900kcw.com//?r=home/lottery/fc7lc&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: a
			// },
	...
	cjdlt: function(e) {
		var t = e.url,
			...
			n = !1;
		config.ifdebug && console.log("obj：" + JSON.stringify(e)), $.ajax({
			url: "http://m.900kcw.com//?r=home/lottery/cjdlt&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: a
			// },
	...
	tcpl3: function(e) {
		var t = e.url,
			...
			n = !1;
		config.ifdebug && console.log("obj：" + JSON.stringify(e)), $.ajax({
			url: "http://m.900kcw.com//?r=home/lottery/tcpl3&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: a
			// },
	...
	tcpl5: function(e) {
		var t = e.url,
			...
			n = !1;
		config.ifdebug && console.log("obj：" + JSON.stringify(e)), $.ajax({
			url: "http://m.900kcw.com//?r=home/lottery/tcpl5&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: a
			// },
	...
	tcqxc: function(e) {
		var t = e.url,
			...
			n = !1;
		config.ifdebug && console.log("obj：" + JSON.stringify(e)), $.ajax({
			url: "http://m.900kcw.com//?r=home/lottery/tcqxc&num=" + e,
			type: "GET",
			// data: {
			// 	lotCode: a
			// },
	...
	var t = "",
		...
		o = i.getMinutes(),
		l = i.getSeconds();
	return "ymd" == e ? t = a + "-" + n + "-" + s : "ymdhms" == e ? t = a + "-" + n + "-" + s + " " + r + ":" + o + ":" + l : "d" == e && (t = s), t
	...
	for (var n = i.preDrawCode.split(","), s = [], r = 0; r < n.length; r++) {
		if (1 != n[r].charAt(0)) o = n[r].charAt(1);
		else var o = n[r];
		s.push(o)
	}
	var l = s.toString();
