<?php exit;?>0015485068163907e42227f5d0413ec721f940e46ad3s:49748:"a:2:{s:8:"template";s:49683:"<html><!DOCTYPE html>
<html>
							...
							<div class="haomaline">
								...
								<div class="numberqu">
									<div class="nuberqutit">
										<div class="divl">
											<a href="<?php echo $parentCategoryInfo["urlname"];?>.html"><span class="pk10tit">极速赛车</span></a>第<span class="redfont preDrawIssue"></span>期&nbsp;开奖
										</div>
										<div class="divr">
...
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>$parentCategoryInfo['class_id'], "limit"=>10));  if(is_array($listList)) foreach($listList as $list){ ?>
...
<?php $__Template->display("themes/168pc/foot"); ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10kai_luzhufxzh.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/jishushaiche_kai.js"></script>

</html>";s:12:"compile_time";i:1516970816;}";