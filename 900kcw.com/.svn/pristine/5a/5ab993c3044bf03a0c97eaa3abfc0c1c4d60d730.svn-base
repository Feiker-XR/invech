<?php exit;?>0015503968601c7019972599b52053af996c3c39c9dfs:12246:"a:2:{s:8:"template";s:12181:"
<!DOCTYPE html>
<html>
		...
		<div class="bodybox">
				...
				<div class="haomaqu" id="<?php echo $categoryInfo["cpid"];?>">
						...
						<div class="haomaline homaline2">
							...
							<div class="newtuijian ">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/ticaipailie555569797.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						<div class="haomaqur_l">
							...
							<div class="line linetit height40">每日20:30:00开奖</div>
			...
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>525 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/tcpl5_kaijiang.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/tcpl5_index.js"></script>
...
</html>";s:12:"compile_time";i:1518860860;}";