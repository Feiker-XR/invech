<?php exit;?>001550396504b895923ad856b8fa343e26c6d494813cs:11175:"a:2:{s:8:"template";s:11110:"<!DOCTYPE html>
<html>
	<head>
				...
				<div class="haomaqu" id="cqSsc">
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								<ul class="zoushimap">
									...
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>391 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									...
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
												<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>391, "class_id"=>'396,397,398,399,400,401'));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
										<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
									</li>
                                 <?php } ?>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/video/nmg_video.jpg"/>
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					<ul class="zoushimap" id="kaijiangjl">
						...
						<li class="kaihistory">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>401 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>	
						</li>
					</ul>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/kuai3_kai/kuai3_nmgkai.js" ></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/kuai3_video/Kuai3_neimenggu.html"></iframe>
			</div>
		</div>
	</div>
</html>";s:12:"compile_time";i:1518860504;}";