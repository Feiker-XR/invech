...
method.listData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/history/ssc_900",
		type: "GET",
		// data: {
		// 	"lotCode": lotCode
		// },
...
method.todayData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/lottery/ssc_double_count&date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
method.longData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/lottery/ssc_long_dragon&date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
