<?php exit;?>001550392556a3c30f3847ed218a773546e0ff336deas:5930:"a:2:{s:8:"template";s:5866:"
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<?php $__Template->display("themes/m/foot"); ?>
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;"src="/themes/m/js/lib/video/SSC/jisusc_index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/ssc/head_jisussc.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/ssc/index.js"></script>
		<script type="text/javascript"src="/themes/m/js/lib/GA.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>";s:12:"compile_time";i:1518856556;}";