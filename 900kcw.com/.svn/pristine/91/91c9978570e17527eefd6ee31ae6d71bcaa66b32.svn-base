...
function listData(time) {
	...
	var date = (time == undefined ? "" : time); //如果请求数据time为undefined处理为""
	$.ajax({
		url: "http://www.900kcw.com/?r=home/count/gxklsf_num_roadbead&date=" + date,
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function createHtmlGetData(jsondata) {
	...
	var dataarr = data.result.data;
	$(dataarr).each(function(index) {
		forRankYibu(dataarr[index].drawCode, dataarr[index])
	})
}
//校正背景偏移
...
function forRank(rank, data) {
	...
	var $boxnumb = $("#box" + boxList(rank, "1"));
...
function boxList(rank, data) {
	...
	if(rank == 1 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 2 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 3 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 4 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 5 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 6 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 7 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 8 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 9 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 10 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 11 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 12 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 13 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 14 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 15 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 16 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 17 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 18 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 19 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 20 && data == 1) {
		box = "" + rank + "" + data;
	} else if(rank == 21 && data == 1) {
		box = "" + rank + "" + data;
	}
	return box;
}
