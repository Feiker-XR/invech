...
indexObj.ajaxSsc = function(issue, id, flag) {
	...
	$.ajax({
		// url: urlbublic + "lotteryJSFastThree/getBaseJSFastThree.php?issue=" + issue,
		url: "http://www.900kcw.com/?r=home/lottery/nmgk3&num=" + code,
		type: "GET",
		// data: {
		// 	"lotCode":lotCode
		// },
...
function creatDataHead2(jsondata, id) {
	publicmethod.insertHeadJsk3_2(jsondata,id);
	var data = null;
	if(typeof jsondata != "object") {
		data = JSON.parse(jsondata);
	} else {
