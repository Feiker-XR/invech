...
function listData() {
	...
	$.ajax({ //http://192.168.1.140:8080/kai-api/pks/queryToDayNumberLawOfStatistics.php?date=2016-10-11
		url: "http://www.900kcw.com/?r=home/count/pk10_trend_count&date=",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
