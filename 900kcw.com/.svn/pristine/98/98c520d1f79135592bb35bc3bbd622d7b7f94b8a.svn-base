...
function listData(date) {
	...
	$.ajax({
		url: "https://api.api68.com/gxklsf/getHistoryLotteryInfo.do?date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function createHtmlList(jsondata) {
	...
	$("#jrsmhmtj>table").html('<tr><th width=150>时间</th><th width=80>期数</th><th id="numberbtn" class="numberbtn" width=386><span id="xshm" class="spanselect">显示号码</span><span id="xsdx">显示大小</span><span id="xsds">显示单双</span></th><th colspan="3">总和</th><th>尾大小</th><th>龙虎</th></tr>');
	$(data).each(function(index) {
		...
		$(preDrawCode).each(function() {
			if(this == 1 || this == 4 || this == 7|| this == 10 || this == 13|| this == 16 || this == 19) {
				tdli += "<li class='gxnumred' style='color:#292c2e;font-size:20px'><i>" + this + "</i></li>";
			} else if(this == 2 || this == 5 || this == 8 || this == 11 || this == 14 || this == 17 || this == 20) {
				tdli += "<li class='gxnumblue' style='color:#292c2e;font-size:20px'><i>" + this + "</i></li>";
			} else if(this == 3  || this == 6  || this == 9  || this == 12  || this == 15  || this == 18  || this == 21){
				tdli += "<li class ='gxnumgreen' style='color:#292c2e;font-size:20px'><i>" + this + "</i></li>"
			}
		});
