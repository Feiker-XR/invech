...
function listData(date) {
	...
	$.ajax({
		// url: urlbublic + "/pks/getPksHistoryList.php?date=" + date,
		url: "https://api.api68.com/pks/getPksHistoryList.do?date=",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function longData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/lottery/pk10_long_dragon",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
