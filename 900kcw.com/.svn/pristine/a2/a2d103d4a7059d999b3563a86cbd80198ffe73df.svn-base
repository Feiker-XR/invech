<?php exit;?>001550396509e46dd896ee8d3a53d1c755c248749b47s:6057:"a:2:{s:8:"template";s:5993:"<!DOCTYPE html>
<html>
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
			...
			<div class="headNum" id="headerData">
				...
				<div class="divline drawTimebox cuttime">
					...
					<div class="flexc margtp78">
						...
						<input type="hidden" class="drawIssue" />
					</div>
			...
			<div class="ListHead">
				...
				<div class="drawCodebox kaijianghm">
					<div class="linebox">
						...
						<div class="rightspan">
							<div class="rightdivhead">
								<span id="">号码</span>
								<span id="">&nbsp;</span>
								<span id="">大小/单双</span>
								<span id="gjlh">鱼虾蟹</span>
							</div>
						</div>
					</div>
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/kuai3_video/k3_bjft.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/lib/config.js?v=20179131640"></script>
		<script type="text/javascript" src="/themes/m/js/local/tools/tools.js?v=20179131640"></script>
		<script type="text/javascript" src="/themes/m/js/local/jsks/head_bjft.js?v=20179131640"></script>
		<script type="text/javascript" src="/themes/m/js/local/jsks/index.js?v=20179131640"></script>
		<script type="text/javascript" src="/themes/m/js/lib/GA.js?v=20179131640"></script>
		<div id="datePlugin"></div>
	</body>

</html>
";s:12:"compile_time";i:1518860509;}";