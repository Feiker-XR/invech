<?php exit;?>00154903371407849db274e9ff6a01e69e195f604168s:1881:"a:2:{s:8:"template";s:1817:"<html><!DOCTYPE html>
<html>
  ...
  <head>
    ...
    <title><?php echo $contentInfo["title"];?>-<?php echo $sys["site_title"];?></title>
...
<div class="news-l">
	 ...
	 <div class="ninfo">
          <div class="nn_title"><strong><?php echo $contentInfo["title"];?></strong></div>
          <div class="nn_line">小编：administrator&nbsp;&nbsp;&nbsp;&nbsp;发布时间：<?php echo date('Y-m-d H:i:s',$contentInfo["time"]); ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击：<?php echo $contentInfo["views"];?></div>
          <div class="nn_info">
...
";s:12:"compile_time";i:1517497714;}";