<?php exit;?>001550500509bb59840118a13b3a52df5b99e7331db8s:13621:"a:2:{s:8:"template";s:13556:"<html><!DOCTYPE html>
<html>
		...
		<div class="bodybox">
				...
				<div class="haomaqu" id="<?php echo $categoryInfo["cpid"];?>">
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30 li_td">
								<ul class="zoushimap">
									...
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>488 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
											<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>488, "class_id"=>'493,494,495,496,497,498,499,500,501,502,503,504,505'));  if(is_array($listList)) foreach($listList as $list){ ?>
												<li class="list">
													<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
												</li>
                                              <?php } ?>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/video/azxy10_video.jpg" />
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>505 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?> 					
                        </div>
					<div id="selectcolor">
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate">
					<div class="loading_azxy10"></div>
					<iframe style="height:100%;width:100%;border: none;" src="/themes/168pc/js/lib/finishAnimation/azxy10_index.html"></iframe>
				</div>
			</div>
		</div>
	</body>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/aozxy10/aozxy10_kai.js"></script>
...
</html>";s:12:"compile_time";i:1518964509;}";