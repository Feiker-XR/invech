$(function() {
	...
	$(".numberbtn span").live("click", function() {
		...
		tools.bigOrSmallTot_2($(this).attr("id"), 6);
	});
...
function ajaxRequst(issue) {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/lottery/syydj&num=" + issue,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function listData(date) {
	...
	$.ajax({
		// url: "http://www.900kcw.com/?r=home/history/syydj&=" + date,
		url: "https://api.api68.com/ElevenFive/getElevenFiveList.do?date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function todayData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/lottery/syx5_double_count",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function longData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/lottery/syx5_long_dragon&date=",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
