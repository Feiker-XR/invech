...
function getK(t) {
    ...
    case 10006:
        ...
        break;
    case 10007:
        jumpHtml("html/kuai3/kuai3_index.html");
        break;
    case 10008:
...
function getH(t) {
    ...
    case 10006:
        ...
        break;
    case 10007:
        jumpHtml("html/kuai3/kuai3index_history.html");
        break;
    case 10008:
...
function jumpHtml(t) {
    window.open(config.wwwUrl + "" + t)
}
var config = {
    publicUrl: "http://127.0.0.1/kj/",
    wwwUrl: "//120.168.com/",
    ifdebug: !1,
    listTime: 2e3,
    startTime: 1e3,
    ...
    path: function() {
        ...
        m = "https" == t.split(":")[0] ? "https": "http";
        return config.ifdebug ? m + "://" + t.split("/")[2] + "/kaiTransfer/view/": -1 != t.split("/")[2].indexOf("192") ? m + "://" + t.split("/")[2] + "/kaiTransfer/view/": m + "://" + t.split("/")[2] + "/"
    }
},
constant = {
    pk10: {
