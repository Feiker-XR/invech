<?php exit;?>0015503966554e33c35901f285d55a1137c8dbea18das:5933:"a:2:{s:8:"template";s:5869:"
<!DOCTYPE html>
<html>
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		<div class="pagediv">
			...
			<!--
            	...
            	描述：头部开奖
            -->
			<div class="headNum headNumSm" id="headerData">
				<div class="divline issuel">
					<span class="issue"><span class="preDrawIssue">588258</span>期开奖</span>
					<span class="drawCount">每日21:15:00开奖</span>
				</div>
				<div class="divline drawCodel">
					<ul id="pk10num" class="sscli redqiu">
						<li>03</li>
						<li>01</li>
						<li>05</li>
					</ul>
				</div>
				<div class="divline drawCodel tiger displaynone">
			...
			<div class="ListHead">
				<div class="headTitle">
					<div id="kaijianghm" class="checkedbl"><span class="single">开奖号码<i></i></span></div>
				</div>
				<!--
                	时间：2017-01-10
                	描述：开奖号码
				...
				<div class="drawCodebox kaijianghm">
					<div class="linebox">
						<div class="leftspan leftspanb">
							<span class="leftspan">时间</span>
							<span class="leftspan midillspan">期数</span>
							<span class="rightspan padleft1">试机号</span>
						</div>
						<div class="rightspan">
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/fc3DVideo/index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/qgc/fc3D_kaijiang.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/qgc/fc3D_index.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>";s:12:"compile_time";i:1518860655;}";