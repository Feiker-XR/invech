<?php exit;?>0015493802056ad41d0e267e559552adea504be432b6s:7849:"a:2:{s:8:"template";s:7785:"<html><!DOCTYPE html>
<html>
	<head>
...
<?php $__Template->display("themes/168pc/head"); ?>
		<?php $__Template->display("themes/168pc/html/shishicai_cq/kj"); ?>
			<div class="kaijiangjl margt20">
				<div class="head">
					<ul class="zoushimap" id="kaijiangjl">
						<li class="kaijiltit">综合分析</li>
						<li id="jrsmtj">
						...
						<!--<li id="xsdx">
							<a href="javascript:">显示大小</a>
							<i></i>
						</li>
						<li id="xsds">
							<a href="javascript:">显示单双</a>
							<i></i>
						</li>-->
					</ul>
				</div>
				<div class="listcontent">
					...
					<div class="jrsmhmtj" id="jrsmhmtj">
						<table class="kjjltable" cellpadding="1" cellspacing="1" border="0">
							<tr>
								<th>时间</th>
								<th>期数</th>
								<th width="500" id="numberbtn" class="numberbtn">
									开奖号码
								</th>
								<th colspan="3">总和</th>
								<th>龙虎</th>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/shishicai_cq/ssc_zhonghefx.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/animate/animate.js" ></script>
</html>";s:12:"compile_time";i:1517844205;}";