...
function listData() {
	...
	$.ajax({
		url: urlbublic + "lotteryJSFastThree/queryBigAndSmallTrend.php?date=" + time + "&issue=" + issue + "&periods=" + periods,
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function forRank(data) {
	...
	$(data).each(function(index) {
		...
		$(this.bodyList).each(function() {
			...
			var missingtd6 = "";
			var missingtd7 = "";
			$(this.numberDistribution).each(function(index) {
				var title = "";
				var bgqiu = "";
				var value = "";
				var value1 = "2";
				...
				function choseRepeat(attr) {
					var ary = attr;
					var nray = ary;
					var count = 0;
					var jsonStr = {};
					for(var i = 0; i < ary.length; i++) {
						for(var j = 0; j < nray.length; j++) {
							if(ary[i] == nray[j]) {
								count += 1;
								jsonStr[ary[i]] = count;
							}
					...
					if(config.ifdebug) {
						console.log("出现的次数key为号码,value为次数" + JSON.stringify(jsonStr));
					}
					return jsonStr;
				}

				var linejson = choseRepeat(drawCode);
				var getcs = linejson[value];
				if(getcs > 1) {
					icon = "<i class = ''>" + getcs + "</i>"
				}

				missingtd1 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span>" + icon + "</td>";
			});
			$(this.hundredForm).each(function(index) {
				var title = "";
				var bgqiu = "";
				var value = "";
				if(index == 0) {
					...
					missingtd21 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				} else if(index == 1) {
					if(this * 1 > 0) {
						title = "title='0'";
						bgqiu = "style='background:" + color[1] + "'";
					...
					missingtd22 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				}
				var stylebg = "";
				if(index < 7) {
					stylebg = "style='background-color:#fcf9f2'"
			...
			$(this.tenForm).each(function(index) {
				var title = "";
				var bgqiu = "";
				var value = "";
				if(index == 0) {
					...
					missingtd31 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				} else if(index == 1) {
					if(this * 1 > 0) {
						title = "title='0'";
						bgqiu = "style='background:" + color[1] + "'";
					...
					missingtd32 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				}
				var stylebg = "";
				if(index < 7) {
					stylebg = "style='background-color:#fcf9f2'"
			...
			$(this.unitForm).each(function(index) {
				var title = "";
				var bgqiu = "";
				var value = "";
				if(index == 0) {
					...
					missingtd41 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				} else if(index == 1) {
					if(this * 1 > 0) {
						title = "title='0'";
						bgqiu = "style='background:" + color[1] + "'";
					...
					missingtd42 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				}
				var stylebg = "";
				if(index < 7) {
					stylebg = "style='background-color:#fcf9f2'"
			...
			$(this.sizeCompare).each(function(index) {
				var title = "";
				var bgqiu = "";
				var value = "";
				if(index == 0) {
					...
					missingtd51 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				} else if(index == 1) {
					if(this * 1 > 0) {
						title = "title='0'";
						bgqiu = "style='background:" + color[1] + "'";
					...
					missingtd52 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				} else if(index == 2) {
					if(this * 1 > 0) {
						title = "title='0'";
						bgqiu = "style='background:" + color[1] + "'";
					...
					missingtd53 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				} else if(index == 3) {
					if(this * 1 > 0) {
						title = "title='0'";
						bgqiu = "style='background:" + color[1] + "'";
					...
					missingtd54 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
				}
				var stylebg = "";
				if(index < 7) {
					stylebg = "style='background-color:#fcf9f2'"
			...
			$(this.bigNumber).each(function(index) {
				var title = "";
				var bgqiu = "";
				var value = "";
				if(this * 1 >= 0) {
				...
				missingtd6 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
			});
			$(this.smallNumber).each(function(index) {
				var title = "";
				var bgqiu = "";
				var value = "";
				if(this * 1 >= 0) {
				...
				missingtd7 += "<td " + stylebg + " " + title + "><span " + bgqiu + ">" + value + "</span></td>";
			});
			var tr = "<tr class='yiloutr'>" + preIssue + "" + preDrawCode + "" + missingtd1 + "" + missingtd21 + "" + missingtd22 + "" + missingtd31 + "" + missingtd32 + "" + missingtd41 + "" + missingtd42 + "" + missingtd51 + "" + missingtd52 + "" + missingtd53 + "" + missingtd54 + "" + missingtd6 + "" + missingtd7 + "</tr>";
		...
		var tr3 = "<td class='font14' colspan='2'>最大连出</td>";
		var tr4 = "<td class='font14' colspan='2'>最大遗漏</td>";
		//循环最大连出
		$(this.bigAndSmallTrendTitle).each(function(index) {
			//不同的索引添加不同的表头
			//循环第一行
...
function drawLine(table) {
				...
				function() {
					if($(this).attr("title") == "0") {
						if($(this).index() >= 2 && $(this).index() <= 7) {
							...
							$(this).attr("class", "hot " + $(this).removeClass("grey").attr("class")).find("i").attr("name", "hotSpan").text($(this).attr("name")).attr("class", "smallQiu");
	...
	//画线
	//	chartOfBaseTrend.kuai3dwzs1();
	//	chartOfBaseTrend.kuai3dwzs2();
	//	chartOfBaseTrend.kuai3dwzs3();
	chartOfBaseTrend.kuai3dwzs4();
	chartOfBaseTrend.kuai3dwzs5();
}
