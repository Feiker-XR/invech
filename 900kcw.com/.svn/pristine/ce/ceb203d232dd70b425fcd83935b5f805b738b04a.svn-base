...
indexObj.ajaxSsc = function(issue, id, flag) {
	...
	$.ajax({
		// url: urlbublic + "LuckTwenty/getBaseLuckTewnty.php?issue=" + issue,
		url: "http://www.900kcw.com/?r=home/lottery/bjkl8&num=" + code,
		type: "GET",
		// data: {
		// 	"lotCode":lotCode
		// },
...
function creatDataHead2(jsondata,id) {
	publicmethod.insertHeadBjkl8_2(jsondata,id);
	tools.setTimefun_bjkl8();
}