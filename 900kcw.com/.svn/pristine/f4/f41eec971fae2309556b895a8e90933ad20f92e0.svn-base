...
// function sscIosMethod(e){
// 	startVideo();
// 	$("iframe")[0].contentWindow.ifopen = true;
// 	$("iframe")[0].contentWindow.sscAnimateEnd(e);
// 	alert("dfdfsdfsda")
// }
...
method.listData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/history/cqssc",
		type: "GET",
		// data: {
		// 	"lotCode": lotCode
		// },
...
method.todayData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/lottery/ssc_double_count" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
method.longData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/lottery/ssc_long_dragon" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
