<?php exit;?>001550567569b712864a536100aa648cb8b4b430632ds:5615:"a:2:{s:8:"template";s:5551:"<html><!DOCTYPE html>
<html>
...
<?php } ?>
			...
			<div class="zhlzbox margt20">
				...
				<div class="listboxinfor">
					<p class="pklhlz_p">使用说明：统计开奖号码的龙虎出现次数 </p>
				</div>
			</div>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10_longhutj.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10_kai.js"></script>

</html>";s:12:"compile_time";i:1519031569;}";