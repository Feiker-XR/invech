<?php exit;?>0015505686268d49d236903ccade4d563e282d94a8b4s:18531:"a:2:{s:8:"template";s:18466:"<!DOCTYPE html>
...
<?php } ?>
						...
						<div class="box">
							<div id="waitBox" class="bastren w1200">
								<div id="chartLinediv" style="position:relative;*position:static;">
									...
									<div id="hovediv" style="position: absolute;top: 0;left: 0;width: 3276px;z-index: 1000;"></div>
									<table id="trend_table2" width="3276" border="0" cellpadding="0" cellspacing="0">
										<thead>
											<tr class="first_th">
												<th width="90" rowspan="2" class="left_border left_b left_strong_down"><strong id="order" style="cursor:pointer;" type="desc">期号</strong></th>
								...
								<div id="chartbottom" style="display: none;">
									<table>
										<tr class="first_th">
											<th width="276" rowspan="2" colspan="2" class="left_border left_b verline">数据统计</th>
											<th colspan="10">冠军</th>
											<th colspan="10">亚军</th>
											<th colspan="10">第三名</th>
											<th colspan="10">第四名</th>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10_haomazs.js"></script>
