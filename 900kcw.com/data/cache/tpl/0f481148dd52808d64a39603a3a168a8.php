<?php exit;?>0015503930664872602531ab902b611e2e2402d4d964s:7061:"a:2:{s:8:"template";s:6997:"<html><!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/head"); ?>
			<div class="haomabox">
				...
				<div class="haomaqu haomaquh">
					<div class="haomaqubox" id="cqSsc">
						<div class="haomaqul">
							<div class="haomaline">
								<div class="haomaimg">
								...
								<div class="numberqu">
									<div class="nuberqutit">
										<div class="divl">
											<a href="/<?php echo $parentCategoryInfo["urlname"];?>.html"><span class="pk10tit"><?php echo $parentCategoryInfo["name"];?></span></a>第<span class="preDrawIssue"></span>期&nbsp;开奖
										</div>
										<div class="divr">
						...
						<div class="haomaqur">
							<div class="line linetime" id="timebox">
								...
								<div class="clock cuttime" id="timebox">
...
<?php $__Template->display("themes/168pc/foot"); ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/shishicai_cq/ssc_kjhistory.js"></script>
...
</html>";s:12:"compile_time";i:1518857066;}";