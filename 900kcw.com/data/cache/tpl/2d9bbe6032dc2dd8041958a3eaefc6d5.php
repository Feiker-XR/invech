<?php exit;?>0015505689852b6c60364bf6a58ae355437e97a10570s:7688:"a:2:{s:8:"template";s:7624:"<!DOCTYPE html>
							...
							<div id="waitBox" class="bastren w1200">
								<div id="chartLinediv" style="position:relative;*position:static;">
									<table id="table_weizhi" width="100%" border="0" cellpadding="0" cellspacing="0" style="display: table;">
										<thead>
											<tr class="firthtd first_th">
												<th rowspan="2" width="150" height="38" class="left_border left_b left_strong_down">期号</th>
												<th rowspan="2" width="150">开奖号码</th>
												<th colspan="10" width="40" id="qiuhao">第一位号码走势</th>
												<th colspan="10" width="40">第二位号码走势</th>
												<th colspan="10" width="40">第三位号码走势</th>
											</tr>
											<tr class="secondtd second_th">
												<th width="40">1</th>
												<th width="40">2</th>
												<th width="40">3</th>
												<th width="40">4</th>
...
<?php $__Template->display("themes/168pc/foot"); ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/kuai3/kuai3_dinweizs.js"></script>
...
</html>";s:12:"compile_time";i:1519032985;}";