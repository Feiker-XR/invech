<?php exit;?>001550395862016df530056fe28b3031c9b93c4a92d7s:6319:"a:2:{s:8:"template";s:6255:"<!DOCTYPE html>
<html>
...
<title>【<?php echo $categoryInfo["name"];?>开奖结果】<?php echo $categoryInfo["name"];?>开奖查询_<?php echo $categoryInfo["name"];?>开奖号码-<?php echo $sys["site_title"];?></title>
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/11x5_video/shef_index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/gdsyxw/head_shef.js"></script>
...
";s:12:"compile_time";i:1518859862;}";