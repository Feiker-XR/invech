<?php exit;?>001550396704105f88822629fa2eee95b49f41bf9c90s:12385:"a:2:{s:8:"template";s:12320:"
<!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/head"); ?>
				...
				<div class="haomaqu" id="<?php echo $categoryInfo["cpid"];?>">
							...
							<div class="numberqu">
								...
								<div class="kajianhao">
									<ul>
										...
										<li class="numblueHead numred">4</li>
										<li class="numblueHead numred">3</li>
										<li class="numblueHead numred">2</li>
						...
						<div class="haomaline homaline2">
							...
							<div class="newtuijian ">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/fucaishuangseqiu.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						<div class="haomaqur_l">
							...
							<div class="line linetit height40">每周二、四、日21:30:00开奖</div>
						...
						<div class="line margt20 guangimg">
							<a href="javascript:void(0)" target="_blank">
								<img src="/themes/168pc/img/banner/img03.jpg" />
							</a>
						</div>
					</div>
				</div>
			...
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>514 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/fcssq_kaijiang.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/fcssq_index.js"></script>
...
</html>";s:12:"compile_time";i:1518860704;}";