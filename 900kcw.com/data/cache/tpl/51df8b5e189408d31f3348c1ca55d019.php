<?php exit;?>0015485089987a5ecaed8f8103b565d10cae75dec69es:12480:"a:2:{s:8:"template";s:12415:"
<!DOCTYPE html>
<html>
		...
		<div class="bodybox">
				...
				<div class="haomaqu" id="shiyix5">
					<div class="haomaqul">
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								...
								<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>256 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
												<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>256, "class_id"=>'261,262,263,264,265,266,267,268,269'));  if(is_array($listList)) foreach($listList as $list){ ?>
												<li class="list">
													<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
												</li>
                                              <?php } ?>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/11x5_Img/11x5_hb.jpg"/>
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>269 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>				
                        	</div>
				</div>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/shiyix5_gd/hubei5_kai.js"></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/11x5_video/hbef_index.html"></iframe>
			</div>
		</div>
	</div>
</html>";s:12:"compile_time";i:1516972998;}";