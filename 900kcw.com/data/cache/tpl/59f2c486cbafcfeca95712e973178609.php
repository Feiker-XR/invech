<?php exit;?>0015505690635fa3d4294ee5267c8dd9c4321b70c264s:12347:"a:2:{s:8:"template";s:12282:"
<!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/html/kuai3_hebei/kj"); ?>
				...
				<div class="listbox">
					...
					<div class="listcontent">
						<div class="box">
									...
									<table class="lz_table_head  g_w1000">
										<tbody>
											<tr>
												...
												<td></td>
												<td class="righttd">
													<span class="now_l"></span><span class="jinri">今天</span>&nbsp;累计总来(<span class="count left_count" data="大">0</span>)&nbsp;&nbsp;没来(<span class="count right_count" data="没来">0</span>)
									...
									<table class="lz_table_head  g_w1000">
										<tbody>
											<tr>
												...
												<td></td>
												<td class="righttd">
													<span class="now_l"></span><span class="jinri">今天</span>&nbsp;累计总来(<span class="count left_count" data="">0</span>)&nbsp;&nbsp;没来(<span class="count right_count" data="">0</span>)
													<span class="important"><span class="ifgj"></span>&nbsp;<span class="ifds"></span>&nbsp;&nbsp;&nbsp;最新</span>
												</td>
												<td class="tobottom"></td>
											</tr>
									...
									<table class="lz_table_head  g_w1000">
										<tbody>
											<tr>
												...
												<td></td>
												<td class="righttd">
													<span class="now_l"></span><span class="jinri">今天</span>&nbsp;累计总来(<span class="count left_count" data="龙">0</span>)&nbsp;&nbsp;没来(<span class="count right_count" data="单">0</span>)
													<span class="important"><span class="ifgj"></span>&nbsp;<span class="ifds"></span>&nbsp;&nbsp;&nbsp;最新</span>
												</td>
												<td class="tobottom"></td>
											</tr>
							...
							<div class="infortxt">
							<p>“X”表示历史对应的某一期未出现该号码，“√”表示历史对应的某一期未出现了该号码。</p>
						</div>
						</div>
					</div>
				</div>
...
<?php $__Template->display("themes/168pc/foot"); ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/kuai3_kai/kuai3_hebkai.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/animate/animate.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/kuai3/kuai3_haomalz.js"></script>

</html>";s:12:"compile_time";i:1519033063;}";