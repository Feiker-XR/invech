<?php exit;?>0015503934500c4b9f15d1847bd0709dd58bb83a6794s:7961:"a:2:{s:8:"template";s:7897:"
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="/themes/168pc/css/PC_egxy28.css" />
				...
				<div class="haomaqu" id="egxy">
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								<ul class="zoushimap">
									...
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>166 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
							...
							<div class="newtuijian">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/PCdandanxingyun2848514857.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/pcEgg.jpg"/>
						</div>
					</div>
				</div>
			</div>
...
<?php $__Template->display("themes/168pc/foot"); ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/PC_egxy28/PC_egxy28kai.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/PC_egxy28/PC_egxy28index.js"></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/pcEgg_video/index.html"></iframe>
			</div>
		</div>
	</div>

</html>";s:12:"compile_time";i:1518857450;}";