<?php exit;?>001549415708117efa3856b166b764b9ddb4679e709es:12638:"a:2:{s:8:"template";s:12573:"
<!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/head"); ?>
				...
				<div class="haomaqu" id="<?php echo $categoryInfo["cpid"];?>">
					<div class="haomaqul">
						<div class="haomaline">
							...
							<div class="numberqu">
								...
								<div class="kajianhao">
									<ul>
										<li class="numblueHead numred">3</li>
										<li class="numblueHead numred">2</li>
										<li class="numblueHead numred">6</li>
									</ul>
								</div>
						...
						<div class="haomaline homaline2">
							...
							<div class="newtuijian ">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/fucai3D10051100.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						<div class="haomaqur_l">
							...
							<div class="line linetit height40">每日21:15:00开奖</div>
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/video/fc3d.jpg">
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>516 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
				...
				<div class="listcontent">
					...
					<div class="jrsmhmtj" id="jrsmhmtj">
						<table id="jrsmhmtjTab" cellpadding="1" cellspacing="1" border="0" class="nopadding">
						</table>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/fc3D_kaijiang.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/fc3D_index.js"></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/fc3DVideo/index.html"></iframe>
			</div>
		</div>
	</div>

</html>";s:12:"compile_time";i:1517879708;}";