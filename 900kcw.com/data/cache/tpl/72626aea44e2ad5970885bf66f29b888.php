<?php exit;?>001549420255eb10900b922de90869cc38813725cbe5s:8693:"a:2:{s:8:"template";s:8629:"
<!DOCTYPE html>
<html>
	...
	<body>
		<div class="bodybox">
			...
			<div class="haomabox">
				...
				<div class="haomaqu" id="<?php echo $categoryInfo["cpid"];?>">
					<div class="haomaqul">
						<div class="haomaline">
							<div class="haomaimg">
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								<ul class="zoushimap">
									...
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>507 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
							...
							<div class="newtuijian">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/taiwanbinguo.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/video/taibg.jpg" />
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>511 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>					
                        </div>
				</div>
...
<?php $__Template->display("themes/168pc/foot"); ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/taiwanbg/twbg_index.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/taiwanbg/twbg_kaijiang.js"></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/twbgVideo/twbg_index.html"></iframe>
			</div>
		</div>
	</div>

</html>";s:12:"compile_time";i:1517884255;}";