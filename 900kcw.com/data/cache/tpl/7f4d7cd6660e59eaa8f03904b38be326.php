<?php exit;?>0015505672062110d04c9b1dfe9b0c1bd2cfa1693e70s:12404:"a:2:{s:8:"template";s:12339:"
<!DOCTYPE html>
<html>
		...
		<div class="bodybox">
				...
				<div class="haomaqu" id="<?php echo $categoryInfo["cpid"];?>">
							...
							<div class="numberqu">
								...
								<div class="kajianhao">
									<ul>
										...
										<li class="numblue numLightblue">2</li>
						...
						<div class="haomaline homaline2">
							...
							<div class="newtuijian ">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/ticaiqixingcai48564997.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						<div class="haomaqur_l">
							...
							<div class="line linetit height40">每周二、五、日20:30:00开奖</div>
			...
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
               <?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>527 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/tc7xc_kaijiang.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/qgc/tc7xc_index.js"></script>
...
</html>";s:12:"compile_time";i:1519031206;}";