<?php exit;?>0015503925872e4adc7761511d122da0795ed650172ds:5986:"a:2:{s:8:"template";s:5922:"<!DOCTYPE html>
<html>
...
<title>【<?php echo $categoryInfo["name"];?>开奖结果】<?php echo $categoryInfo["name"];?>开奖查询_<?php echo $categoryInfo["name"];?>开奖号码-<?php echo $sys["site_title"];?></title>
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/kuai3_video/k3_hebft.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/jsks/head_hebft.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/jsks/index.js"></script>
		<script type="text/javascript" src="/themes/m/js/lib/GA.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>
";s:12:"compile_time";i:1518856587;}";