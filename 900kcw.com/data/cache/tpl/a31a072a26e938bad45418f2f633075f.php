<?php exit;?>00154849443676636d8f07f046e7eac44a6fbbee610es:14538:"a:2:{s:8:"template";s:14473:"<html><!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/head"); ?>
			<div class="haomabox">
				...
				<div class="haomaqu" id="klsf">
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								<ul class="zoushimap">
									...
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>117 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									...
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
												<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>117, "class_id"=>'123,124,125,126,127,128,129,130,131,132,133,134,135,136'));  if(is_array($listList)) foreach($listList as $list){ ?>
												<li class="list">
													<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
												</li>
                                              <?php } ?>
							...
							<div class="newtuijian">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/guangdongkuaileshifen55984998.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						...
						<!--如果需要轮播就加上id="littleimg"-->
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/gdklsf.jpg">
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
						<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>136 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>
					</div>
				</div>
					...
					<div class="jrsmtj">
						...
						<table cellpadding="1" cellspacing="1" border="0">
							...
							<tr id="shuanmiandata">
								...
								<td class="six3">0</td>
								<td class="six4">0</td>
								<td class="seven1">0</td>
								<td class="seven2">0</td>
								<td class="seven3">0</td>
								<td class="seven4">0</td>
								<td class="eight1">0</td>
								<td class="eight2">0</td>
								<td class="eight3">0</td>
								<td class="eight4">0</td>
							</tr>
						</table>
						<table class="secondtb" cellpadding="1" cellspacing="1" border="0">
							<tr>
								<th width="176" rowspan="2">球次</th>
								<th colspan="4">总和</th>
							...
							<tr id="gylhcs">
								...
								<td class="twol">0</td>
								<td class="twoh">0</td>
								<td class="threel">0</td>
								<td class="threeh">0</td>
								<td class="fourl">0</td>
								<td class="fourh">0</td>
							</tr>
						</table>
						...
						<div class="head">
							...
							<div class="checkbtnr">
								<ul class="zoushimap" id="chakanchfb">
									...
									<li class="12">
										<a href="javascript:">号码12</a>
										<i></i>
									</li>
									<li class="13">
										<a href="javascript:">号码13</a>
										<i></i>
									</li>
									<li class="14">
										<a href="javascript:">号码14</a>
										<i></i>
									</li>
									<li class="15">
										<a href="javascript:">号码15</a>
										<i></i>
									</li>
									<li class="16">
										<a href="javascript:">号码16</a>
										<i></i>
									</li>
									<li class="17">
										<a href="javascript:">号码17</a>
										<i></i>
									</li>
									<li class="18">
										<a href="javascript:">号码18</a>
										<i></i>
									</li>
									<li class="19">
										<a href="javascript:">号码19</a>
										<i></i>
									</li>
									<li class="20">
										<a href="javascript:">号码20</a>
										<i></i>
									</li>
								</ul>
							</div>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/klsf/klsf_index.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/klsf/klsf_kaijiang.js"></script>
	...
	<script src="/themes/168pc/js/lib/idangerous.swiper.min.js"></script>
		...
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/GDklsf/index.html"></iframe>
			</div>
		</div>
	</div>
</html>";s:12:"compile_time";i:1516958436;}";