<?php exit;?>001549783041b42cd376cae59bc0ae675df84dfbb531s:5921:"a:2:{s:8:"template";s:5857:"
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<?php $__Template->display("themes/m/foot"); ?>
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;"src="/themes/m/js/lib/video/SSC/index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/ssc/head_cqssc.js"></script>
...
</html>";s:12:"compile_time";i:1518247041;}";