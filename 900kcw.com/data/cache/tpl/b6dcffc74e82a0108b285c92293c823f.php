<?php exit;?>001549374477f867984da72bc9fc1726eb509dd946a8s:14474:"a:2:{s:8:"template";s:14409:"<html><!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
     ...
     <title>【<?php echo $categoryInfo["name"];?>开奖结果】<?php echo $categoryInfo["name"];?>开奖查询_<?php echo $categoryInfo["name"];?>开奖号码-<?php echo $sys["site_title"];?></title>
		...
		<link rel="stylesheet" href="/themes/168pc/css/shishicai.css" />
...
<?php $__Template->display("themes/168pc/head"); ?>
				...
				<div class="haomaqu" id="cqSsc">
					<div class="haomaqul">
						...
						<div class="haomaline homaline2">
							<div class="haomaimg">
								<p class="kaijianname">极速时时彩</p>
							</div>
							<div class="margt30">
								<ul class="zoushimap">
								<li class="list lihead no_left">走势图表：</li>
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>54 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
												<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>54, "class_id"=>'59,60,61,62,63,64,65,66,67,68'));  if(is_array($listList)) foreach($listList as $list){ ?>
												<li class="list">
													<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
												</li>
                                              <?php } ?>											
							...
							<div class="newtuijian ">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/zhongqingshishicai48569754.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						<div class="haomaqur_l">
							...
							<div class="line soundId">
								<div class="soundline soundSet" id="soundSet">
									<div class="soundbtn"><i>铃声设置</i>
										<div class="soundicon stopsound">
											<audio src="media/RING_01.wav" controls="controls" id="audioid">
										...
										<div class="soundpanel">
											...
											<div class="soundlist">
												<ul>
													<li><label><input type="radio" name="sound" value="none" checked="checked">&nbsp;不提示(默认)</label></li>
													<li><label><input type="radio" name="sound" value="RING_01">&nbsp;声音一(闹钟铃)</label></li>
													<li><label><input type="radio" name="sound" value="RING_02">&nbsp;声音二(上课铃)</label></li>
													<li><label><input type="radio" name="sound" value="RING_03">&nbsp;声音三(打锣声)</label></li>
													<li><label><input type="radio" name="sound" value="RING_04">&nbsp;声音四(打鼓声)</label></li>
													<li><label><input type="radio" name="sound" value="RING_05">&nbsp;声音五(点滴声)</label></li>
													<li>
														提示时间：
														<select>
															<option value="5">开奖前5秒</option>
															<option value="10" selected="selected">开奖前10秒</option>
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/video/jijsu_sscvideo.jpg" />
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
 <?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>67 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>					</div>
					<div id="selectcolor">
						<em>护眼模式</em>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/shishicai_tj/ssc_jishukai.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/shishicai_cq/ssc_index.js"></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/SSC/jisussc_index.html"></iframe>
			</div>
		</div>
	</div>
</html>";s:12:"compile_time";i:1517838477;}";