<?php exit;?>001550392673ae0a792367bd5e1746e18e731b7515b9s:5601:"a:2:{s:8:"template";s:5537:"<html><!DOCTYPE html>
<html>
...
<?php } ?>
					...
					<div class="listcontent nomargin">
						<div class="box">
							<div class="bastren w1200 noboder">
								...
								<p class="listbox_p">统计冠亚和每天单双大小的出现次数.</p>
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10_guanyahelmls.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10_kai.js"></script>

</html>";s:12:"compile_time";i:1518856673;}";