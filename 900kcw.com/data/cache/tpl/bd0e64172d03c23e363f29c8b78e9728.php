<?php exit;?>0015494248039d769ca96d408fff4d0b4302451439ccs:3300:"a:2:{s:8:"template";s:3236:"
<!DOCTYPE html>
<html>
	...
	<body>
		<div class="bodybox">
			...
			<div class="guize">
				...
				<div class="guize_menu">
					<ul>
						<li class="guize_head">
							<strong>玩法规则</strong>
						</li>
					<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>539, "limit"=>30));  if(is_array($listList)) foreach($listList as $list){ ?>
				...
				<div class="guize_detail">
					<div class="container">
						...
						<p style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;text-indent:0;padding:0 0 0 0 ;text-align:center;line-height:30px;background:rgb(255,255,255)">
							<strong><span style="letter-spacing: 0px; font-size: 18px;font-weight: 900;  font-family: 微软雅黑;"><?php echo $categoryInfo["name"];?>玩法规则</span></strong>
						</p>
...
</html>";s:12:"compile_time";i:1517888803;}";