<?php exit;?>00155056862582814b88851464e7b36003391674ba28s:10223:"a:2:{s:8:"template";s:10158:"<!DOCTYPE html>
...
<?php } ?>
			...
			<div class="zhlzbox margt20">
				<div class="listhead">
					<div class="listheadl">
						<span class="lmms"><i>3</i>号码规律统计</span>
					</div>
					<div class="listheadr">
						...
						<!--<div class="listheadrl">
							...
							<span id="thirty" title="30" class="checked">最近30期</span>
							<span id="sixty" title="60">最近60期</span>
							<span id="ninety" title="90">最近90期</span>
						</div>-->
						<div class="listheadrl">
							<span id="today">今天</span>
							<span id="yesterday">昨天</span>
				...
				<div class="listbox">
					...
					<div class="listcontent">
							...
							<div id="waitBox" class="bastren w1200">
								<div id="chartLinediv" style="position:relative;*position:static;">
									<table id="table_weizhi" width="100%" border="0" cellpadding="0" cellspacing="0" style="display: table;">
										<thead>
											<tr>
												<th rowspan="2" width="180" height="38" class="">期号&nbsp;&nbsp;时间</th>
												<th rowspan="2" colspan="12" width="433" class="showhamafb">
														<span class="title">同位开奖号码分布：</span>
														<span id="showt" class="sinli"><i></i>
															显示同位号码
														</span>
												</th>
												<th rowspan="2" width="140">升平降</th>
												<th colspan="2" width="192">单双</th>
												<th colspan="2" width="192">大小</th>
											</tr>
											<tr>
												<th width="96">单</th>
												<th width="96">双</th>
						...
						<div class="infortxt">
							<p>1、【号码规律统计】提供号码开出位置的历史同位号码统计。例如第1期开出号码1后，在第1期开出号码1的相同位置，第2期开出号码为2，则把号码2标示</p>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10_haomagltj.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/lib/echarts.min.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/pk10/pk10_kai.js"></script>
</html>";s:12:"compile_time";i:1519032625;}";