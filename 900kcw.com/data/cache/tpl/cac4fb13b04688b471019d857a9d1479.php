<?php exit;?>001550388887e24319295c2e62ca38c5a06cc4b87ce6s:12980:"a:2:{s:8:"template";s:12915:"<html><!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/head"); ?>
				...
				<div class="haomaqu" id="cqSsc">
						...
						<div class="haomaline">
							...
							<div class="numberqu">
								<div class="nuberqutit">
									<span class="ssc"><?php echo $categoryInfo["name"];?></span>第
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								...
								<li class="list lihead no_left">走势图表：</li>
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>452 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
												<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>452, "class_id"=>'457,458,459,460,461,462,463,464,465,466,467,468'));  if(is_array($listList)) foreach($listList as $list){ ?>
												<li class="list">
													<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
												</li>
                                              <?php } ?>
							...
							<div class="newtuijian">
								<ul class="zoushimap">
									...
									<!--<li class="list">
										<a href="http://www.168luntan.com/forum-36-1.html" target="_blank">论坛交流</a>
									</li>-->
								</ul>
							</div>
						</div>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/video/azxy5_sscvideo.jpg" />
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>468 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>						
                        </div>
					<div id="selectcolor">
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/aozxy5/aozxy5_kai.js"></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/SSC/azxy5_index.html"></iframe>
			</div>
		</div>
	</div>

</html>";s:12:"compile_time";i:1518852887;}";