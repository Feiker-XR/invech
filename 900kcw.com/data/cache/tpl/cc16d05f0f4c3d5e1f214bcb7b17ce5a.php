<?php exit;?>0015503956736c3d0f7c6859fb44e8954104f31c8328s:14391:"a:2:{s:8:"template";s:14326:"<html><!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/head"); ?>
				...
				<div class="haomaqu" id="klsf">
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								<ul class="zoushimap">
									...
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>138 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									...
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
												<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>138, "class_id"=>'143,144,145,146,147,148,149,150,151,152,153,154,155,156'));  if(is_array($listList)) foreach($listList as $list){ ?>
												<li class="list">
													<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
												</li>
                                              <?php } ?>
							...
							<div class="newtuijian">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/zhongqingnongchang.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/video/cqnc_video.jpg" />
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>156 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>					</div>
				</div>
...
<?php $__Template->display("themes/168pc/foot"); ?>
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/cqnc/index.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/cqnc/kaijiang.js"></script>
	...
	<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/cqnc_video/index.html"></iframe>
			</div>
		</div>
	</div>
</html>";s:12:"compile_time";i:1518859673;}";