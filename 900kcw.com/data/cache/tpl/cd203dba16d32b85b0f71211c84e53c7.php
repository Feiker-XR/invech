<?php exit;?>001550396672a7c5d7d66daca4474c8d26db0f5ba87es:5293:"a:2:{s:8:"template";s:5229:"<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		<div class="pagediv">
			...
			<div class="headNum headNumSm" id="headerData">
				<div class="divline issuel">
					...
					<span class="drawCount">每周一、三、六20:30:00开奖</span>
				</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/qgc/dlt_kaijiang.js"></script>
		<script type="text/javascript" src="/themes/m/js/local/qgc/dlt_index.js"></script>
		<div id="datePlugin"></div>
	</body>

</html>
";s:12:"compile_time";i:1518860672;}";