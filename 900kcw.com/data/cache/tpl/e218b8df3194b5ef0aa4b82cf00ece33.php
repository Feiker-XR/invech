<?php exit;?>001548740703296ece231ca50af804397704a8b5968ds:11633:"a:2:{s:8:"template";s:11568:"<form method="post" class="form-x dux-form form-auto" id="form" action="<?php echo url();?>">
            ...
            <div class="tab-body">
                <div class="tab-panel active" id="tab-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="input" id="name" name="name" size="60" datatype="s" value="<?php echo $info["name"];?>">
                                ...
                                <div class="form-group">
                        <div class="label">
                            <label>彩票API id</label>
                        </div>
                        <div class="field">
                         <input type="text" class="input" id="cpid" name="cpid" size="60" value="<?php echo $info["cpid"];?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="input" id="class_tpl" name="class_tpl" size="20" datatype="*" value="<?php echo default_data($info['class_tpl'],'html/');?>">
...
</script>";s:12:"compile_time";i:1517204703;}";