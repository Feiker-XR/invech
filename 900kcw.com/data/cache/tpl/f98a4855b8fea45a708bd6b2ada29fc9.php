<?php exit;?>0015484952994bdcd0f2d8984b656fb33ac85c28d29cs:13383:"a:2:{s:8:"template";s:13318:"
<!DOCTYPE html>
<html>
...
<?php $__Template->display("themes/168pc/head"); ?>
				...
				<div class="haomaqu" id="gxklsf">
					<div class="haomaqul">
						<div class="haomaline">
							...
							<div class="numberqu">
								...
								<div class="kajianhao gx_kajianhao">
									<ul>
						...
						<div class="haomaline homaline2">
							...
							<div class="margt30">
								<ul class="zoushimap">
									...
									<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>158 , "limit"=>4));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
                                 ...
                                 <?php } ?>
									<li class="list morelist" id="morelist">
										...
										<div class="sub_morelist" style="display: none;">
											<ul class="leftUl">
												<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "parent_id"=>158, "class_id"=>'164,165'));  if(is_array($listList)) foreach($listList as $list){ ?>
									<li class="list">
										<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
									</li>
                                 <?php } ?>
							...
							<div class="newtuijian">
								<ul class="zoushimap">
									...
									<li class="list no_left">
										<a href="/guangxikuaileshifen.html">玩法规则</a>
									</li>
					...
					<div class="haomaqur">
						...
						<div class="line margt20 guangimg" id="startVideo">
							<img src="/themes/168pc/img/gxklsf.jpg">
						</div>
					</div>
				</div>
			</div>
			<div class="kaijiangjl margt20">
				<div class="head">
					...
					<div id="kjls">
<?php $listList = service("duxcms","Label","categoryList",array( "app"=>"DuxCms", "label"=>"categoryList", "class_id"=>165 , "limit"=>1));  if(is_array($listList)) foreach($listList as $list){ ?>
						<a href="<?php echo $list["curl"];?>"><?php echo $list["name"];?></a>
                        <?php } ?>					
                        </div>
				</div>
				<div class="listcontent">
					...
					<div class="hmfb">
						<div class="head gx_head">
							<div class="checkbtnl gx_checkbtnl">
								查看球号分布:
							</div>
							<div class="checkbtnr gx_checkbtnr">
	...
	<script type="text/javascript" src="/themes/168pc/js/loacal/klsf_guangxi/klsf_index.js"></script>
	<script type="text/javascript" src="/themes/168pc/js/loacal/klsf_guangxi/klsf_gxkai.js"></script>
...
<div id="videobox">
		<div class="content">
			...
			<div class="animate">
				<iframe style="height:100%;width:100%;border: none;" scrolling="no" src="/themes/168pc/js/lib/video/gxklsf_video/index.html"></iframe>
			</div>
		</div>
	</div>
</html>";s:12:"compile_time";i:1516959299;}";