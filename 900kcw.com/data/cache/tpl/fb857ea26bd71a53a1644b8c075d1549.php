<?php exit;?>00155039652555778b582113f5a244b5a2cf8b3d59c3s:6647:"a:2:{s:8:"template";s:6583:"<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body class="wxgzh iphone withHeader article utms-wxgzh utmm-None utmc-None list-page">
		...
		<div id="videobox">
			<div class="content">
				...
				<div class="animate" style="margin: 0 auto;">
					<iframe style="height:100%;width:100%;border: none;" src="/themes/m/js/lib/video/bjkl8Video/index.html"></iframe>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="/themes/m/js/local/bjkl8/head_bjkl8.js"></script>
...
";s:12:"compile_time";i:1518860525;}";