...
function listData() {
	$.ajax({
		url: urlbublic + "ElevenFive/getElevenFiveList.php?date=",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function todayData() {
	$.ajax({
		url: urlbublic + "ElevenFive/queryDoubleNumber.php",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function longData() {
	$.ajax({
		url: urlbublic + "ElevenFive/getElevenFiveDailyDragon.php",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
