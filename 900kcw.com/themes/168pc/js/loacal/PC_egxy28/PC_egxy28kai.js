$(function() {
	$("#headdivbox").load("../public/head.html?v=201712271451", function() {
		if(config.ifdebug) {
			console.log("request is over!");
		}
	});
	$("#fooderbox").load("../public/fooder.html?v=201712271451", function() {
		if(config.ifdebug) {
			console.log("request is over!");
		}
	});
...
indexObj.ajaxSsc = function(issue, id, flag) {
	...
	var iferror = false;
	var code = $('#egxy').find('.nextIssue').text();
		
	$.ajax({
		// url: urlbublic + "LuckTwenty/getPcLucky28.php?issue=" + issue,
		url: "http://www.900kcw.com/?r=home/lottery/pcddxy28&num=" + code,
		type: "GET",
		beforeSend: function() {
