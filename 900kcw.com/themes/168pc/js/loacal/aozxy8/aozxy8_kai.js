$(function() {
	$("#headdivbox").load("../public/head.html?v=201712221618", function() {
		if(config.ifdebug) {
			console.log("request is over!");
		}
	});
	$("#fooderbox").load("../public/fooder.html?v=201712221618", function() {
		if(config.ifdebug) {
			console.log("request is over!");
		}
	});
...
indexObj.ajaxSsc = function(issue, id, flag) {
	...
	$.ajax({
		...
		url: "http://www.900kcw.com/?r=home/lottery/azxy8&num=" + code,
		type: "GET",
		// data: {
		// 	"lotCode":lotCode
		// },
