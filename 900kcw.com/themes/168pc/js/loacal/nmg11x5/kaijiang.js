...
indexObj.ajaxSsc = function(issue, id, flag) {
	...
	var iferror = false;
	var code = $('#shiyix5').find('.nextIssue').text();
	
	$.ajax({
		// url: urlbublic + "ElevenFive/getElevenFiveInfo.php?issue=" + issue,
		url: "http://www.900kcw.com/?r=home/lottery/nmg11x5&num=" + code,
		type: "GET",
		// data: {
		// 	"lotCode":lotCode
		// },
...
function creatDataHead2(jsondata,id) { 
	publicmethod.insertHead11xw_2(jsondata,id);
	tools.setTimefun_shiyixw();	
}