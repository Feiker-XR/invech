...
function listData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/count/pk10_history_fordsdx",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function forRank(data) {
	...
	$(data).each(function(index) {
		...
		var $td0 = $(this)[0];
		var tddate = "<td width='100'>" + $td0.date + "</td>";
		var tdone = "<td " + style + ">" + $td0.list[0].bigCount + "</td><td " + style + ">" + $td0.list[0].smallCount + "</td><td " + style + ">" + $td0.list[0].singleCount + "</td><td " + style + ">" + $td0.list[0].doubleCount + "</td>";
		var tdtow = "<td>" + $td0.list[1].bigCount + "</td><td>" + $td0.list[1].smallCount + "</td><td>" + $td0.list[1].singleCount + "</td><td>" + $td0.list[1].doubleCount + "</td>";
		var tdthree = "<td " + style + ">" + $td0.list[2].bigCount + "</td><td " + style + ">" + $td0.list[2].smallCount + "</td><td " + style + ">" + $td0.list[2].singleCount + "</td><td " + style + ">" + $td0.list[2].doubleCount + "</td>";
		var tdfour = "<td>" + $td0.list[3].bigCount + "</td><td>" + $td0.list[3].smallCount + "</td><td>" + $td0.list[3].singleCount + "</td><td>" + $td0.list[3].doubleCount + "</td>";
		var tdfive = "<td " + style + ">" + $td0.list[4].bigCount + "</td><td " + style + ">" + $td0.list[4].smallCount + "</td><td " + style + ">" + $td0.list[4].singleCount + "</td><td " + style + ">" + $td0.list[4].doubleCount + "</td>";
		var tdsix = "<td>" + $td0.list[5].bigCount + "</td><td>" + $td0.list[5].smallCount + "</td><td>" + $td0.list[5].singleCount + "</td><td>" + $td0.list[5].doubleCount + "</td>";
		var tdseven = "<td " + style + ">" + $td0.list[6].bigCount + "</td><td " + style + ">" + $td0.list[6].smallCount + "</td><td " + style + ">" + $td0.list[6].singleCount + "</td><td " + style + ">" + $td0.list[6].doubleCount + "</td>";
		var tdeight = "<td>" + $td0.list[7].bigCount + "</td><td>" + $td0.list[7].smallCount + "</td><td>" + $td0.list[7].singleCount + "</td><td>" + $td0.list[7].doubleCount + "</td>";
		var tdnine = "<td " + style + ">" + $td0.list[8].bigCount + "</td><td " + style + ">" + $td0.list[8].smallCount + "</td><td " + style + ">" + $td0.list[8].singleCount + "</td><td " + style + ">" + $td0.list[8].doubleCount + "</td>";
		var tdten = "<td>" + $td0.list[9].bigCount + "</td><td>" + $td0.list[9].smallCount + "</td><td>" + $td0.list[9].singleCount + "</td><td>" + $td0.list[9].doubleCount + "</td>";
		var tr = "<tr height='38'>" + tddate + "" + tdone + "" + tdtow + "" + tdthree + "" + tdfour + "" + tdfive + "" + tdsix + "" + tdseven + "" + tdeight + "" + tdnine + "" + tdten + "</tr>";
