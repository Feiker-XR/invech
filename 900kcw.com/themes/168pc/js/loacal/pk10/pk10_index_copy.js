$(function() {
	...
	//显示号码、显示大小 、显示单双
	$(".numberbtn span").on("click", function() {
		var id = $(this).attr("id");
...
function listData(code) {
	$.ajax({
		// url: urlbublic + "pks/getPksHistoryList.php",
		url: "http://www.900kcw.com/?r=home/history/pk10&=" + code, 
		type: "GET",
		// data: {
		// 	"lotCode":lotCode
		// },
...
function longData() {
	$.ajax({
		// url: urlbublic + "pks/getPksLongDragonCount.php?date=",
		url: "http://www.900kcw.com/?r=home/lottery/pk10_long_dragon&date=",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
