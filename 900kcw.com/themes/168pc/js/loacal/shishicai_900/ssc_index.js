...
function listData(code) {
	$.ajax({
		// url: urlbublic + "CQShiCai/getBaseCQShiCaiList.php",
		url: "http://www.900kcw.com/?r=home/history/ssc_900&=" + code,
		type: "GET",
		// data: {
		// 	"lotCode": lotCode
		// },
...
function todayData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/lottery/ssc_double_count",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
function longData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/lottery/ssc_long_dragon&date=",
		type: "GET",
		data: {
			"lotCode": lotCode
		},
