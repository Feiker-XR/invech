...
function listData(date) {
	...
	$.ajax({
		url: "http://www.900kcw.com/?r=home/count/ssc_history_fordsdx",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function todayData() {
	$.ajax({
		url: urlbublic + "CQShiCai/queryDoubleNumber.php",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function longData() {
	$.ajax({
		url: urlbublic + "CQShiCai/getCQShiCaiDailyDragon.php",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function createHtmlList(jsondata) {
	...
	$(data).each(function(index) {
		...
		var tr = "<tr height='38'>" + tddate + "" + tdone + "" + tdtow + "" + tdthree + "" + tdfour + "" + tdfive + "</tr>";
