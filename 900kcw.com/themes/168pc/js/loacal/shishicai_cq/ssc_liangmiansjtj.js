...
function listData() {
	$.ajax({
		url: "http://www.900kcw.com/?r=home/count/ssc_count_double",
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function forRank(data) {
	...
	$(data).each(function(index) {
		var tddate = "<td width='400'>" + dateCut(this.date) + "&nbsp;&nbsp;&nbsp;&nbsp;" +this.startIssue + "&nbsp;-&nbsp;" +this.endIssue + "期</td>";
		$(this.list).each(function(index) {
			var tdd = "<td width='300'>" +this.singleCount + "</td>";
			var tds = "<td width='300'>" +this.doubleCount + "</td>";
			var tddb = "<td width='300'>" +this.bigCount + "</td>";
			var tdx = "<td width='300'>" +this.smallCount + "</td>";
			var tr = "<tr height='50' class='mc" +this.rank + "'>" + tddate + "" + tdd + "" + tds + "" + tddb + "" + tdx + "</tr>";
