...
function listData() {
	...
	$.ajax({
		url: "http://www.900kcw.com/?r=home/count/syx5_trend_location&num=" + num + "&issue=" + issue + "&date=" + time,
		type: "GET",
		data: {
			"lotCode":lotCode
		},
...
function forRank(data) {
	...
	$(data).each(function(index) {
		...
		//组装第二个表头
		var tbodyhead = $("#chartbottom table tbody").html();
