...
method.listData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/history/ah11x5",
		type: "GET",
		// data: {
		// 	"lotCode": lotCode
		// },
...
method.todayData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com//?r=home/lottery/syx5_double_count&lotCode=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
method.longData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com//?r=home/lottery/syx5_long_dragon&lotCode=" + lotCode + "&date=" + date,
		type: "GET",
		data: {
			'lottObj': ""
		},
