...
method.listData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/history/azxy10&",
		type: "GET",
		// data: {
		// 	"lotCode": lotCode
		// },
...
method.todayData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/lottery/pk10_double_count" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
method.longData = function(date) {
	$.ajax({
		url: "http://m.900kcw.com/?r=home/lottery/pk10_long_dragon" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
