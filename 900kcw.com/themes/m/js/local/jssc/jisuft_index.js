$(function() {
	...
	$("#videobox .closevideo").on("click", function() {
		...
		setTimeout(function(){
			...
			$("iframe")[0].contentWindow.cuttime.pause();			
		},1)
	});
...
method.listData = function(date) {
	$.ajax({
		url: config.publicUrl + "pks/getPksHistoryList.php?date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
method.todayData = function(date) {
	$.ajax({
		url: config.publicUrl + "pks/getPksDoubleCount.php?date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
...
method.longData = function(date) {
	$.ajax({
		url: config.publicUrl + "pks/getPksLongDragonCount.php?date=" + date,
		type: "GET",
		data: {
			"lotCode": lotCode
		},
