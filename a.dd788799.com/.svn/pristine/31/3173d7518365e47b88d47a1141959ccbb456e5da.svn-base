...
!function(t, e) {
        ...
        var o = n(2)
          ...
          , y = function() {
            function t(e, n) {
                ...
                n = n || {},
                this.key = e,
                this.config = r.extend(p.getGlobalConfig(), n.cluster ? p.getClusterConfig(n.cluster) : {}, n),
                this.channels = d.default.createChannels(),
                this.global_emitter = new s.default,
                this.sessionID = Math.floor(1e9 * Math.random()),
                this.timeline = new a.default(this.key,this.sessionID,{
                ...
                this.connection.bind("connected", function() {
                    l.subscribeAll(),
                    l.timelineSender && l.timelineSender.send(l.connection.isEncrypted())
                }),
            ...
            t.prototype.unsubscribe = function(t) {
                ...
                e && e.subscriptionPending ? e.cancelSubscription() : (e = this.channels.remove(t),
            ...
            t.logToConsole = !1,
            t.Runtime = o.default,
            t.ScriptReceivers = o.default.ScriptReceivers,
            t.DependenciesReceivers = o.default.DependenciesReceivers,
            t.auth_callbacks = o.default.auth_callbacks,
            t
        }();
        e.__esModule = !0,
        e.default = y,
    ...
    , function(t, e, n) {
        ...
        var i = n(4)
          , o = n(5)
          , r = n(6);
        e.DependenciesReceivers = new i.ScriptReceiverFactory("_pusher_dependencies","Pusher.DependenciesReceivers"),
    ...
    , function(t, e) {
        ...
        e.ScriptReceivers = new n("_pusher_script_","Pusher.ScriptReceivers")
    }
    , function(t, e) {
        "use strict";
        var n = {
        ...
        var i = n(4)
          ...
          , r = function() {
            ...
            t.prototype.getRoot = function(t) {
                ...
                return e = t && t.encrypted || "https:" === n ? this.options.cdn_https : this.options.cdn_http,
                e.replace(/\/*$/, "") + "/" + this.options.version
            }
            ,
    ...
    , function(t, e, n) {
        ...
        var i = n(8)
          ...
          , r = function(t, e, n) {
            var r, s = this;
            r = o.default.createXHR(),
            r.open("POST", s.options.authEndpoint, !0),
            ...
            return r.onreadystatechange = function() {
                if (4 === r.readyState)
                    if (200 === r.status) {
                        ...
                        i.default.warn("Couldn't get auth info from your webapp", r.status),
                        n(!0, r.status)
            }
            ,
    ...
    , function(t, e, n) {
        ...
        function g(t) {
            return h(t, function(t) {
                return "object" == typeof t && (t = _(t)),
                encodeURIComponent(w.default(t.toString()))
            })
        }
        function m(t) {
            ...
            return function t(i, o) {
                ...
                case "object":
                    ...
                    "[object Array]" === Object.prototype.toString.apply(i))
                        ...
                        a = {};
                        for (s in i)
                            Object.prototype.hasOwnProperty.call(i, s) && (a[s] = t(i[s], o + "[" + JSON.stringify(s) + "]"))
                    }
                    return a;
                case "number":
                case "string":
        ...
        e.any = y,
        e.all = v,
        e.encodeParamsObject = g,
        e.buildQueryString = m,
        e.decycleObject = b,
        e.safeJSONStringify = _
    }
    , function(t, e, n) {
        "use strict";
        function i(t) {
    ...
    , function(t, e, n) {
        ...
        function i() {
            ...
            o.Dependencies.load(t.hooks.file, {
          ...
          , o = {
            getRequest: function(t) {
                ...
                return e.ontimeout = function() {
                    t.emit("error", new i.RequestTimedOut),
                    t.close()
                }
                ,
    ...
    , function(t, e, n) {
        ...
        var i = this && this.__extends || function(t, e) {
          ...
          , a = function(t) {
            ...
            ,
            e.prototype.close = function() {
                this.unloader && (o.default.removeUnloadListener(this.unloader),
                this.unloader = null),
          ...
          , f = function() {
            ...
            t.prototype.sendRaw = function(t) {
                if (this.readyState !== u.default.OPEN)
                    return !1;
                try {
                    return h.default.createSocketRequest("POST", r(o(this.location, this.session))).start(t),
                    !0
                } catch (t) {
                    return !1
                }
            ...
            t.prototype.onOpen = function(t) {
                this.readyState === u.default.CONNECTING ? (t && t.hostname && (this.location.base = s(this.location.base, t.hostname)),
        ...
        var S = {
          ...
          , C = {
            ...
            def_transport: function(t, e, n, i, o, r) {
                var s = k[n];
                if (!s)
                    throw new f.UnsupportedTransport(n);
                ...
                var u = t.def(t, e, a)[1];
                return u.Transports = t.Transports || {},
                u.Transports[e] = a,
                [void 0, u]
            },
    ...
    , function(t, e) {
        ...
        e.processHandshake = function(t) {
            if (t = e.decodeMessage(t),
            "pusher:connection_established" === t.event) {
                ...
                var t = this
                  , e = {
                    message: function(e) {
                        ...
                        if (void 0 !== n) {
                            switch (a.default.debug("Event recd", n),
                            n.event) {
                            case "pusher:error":
                                t.emit("error", {
                                    type: "PusherError",
        ...
        var i = n(2)
          , o = function() {
            function t(t, e) {
                ...
                if ("undefined" == typeof i.default.getAuthorizers()[n])
            ...
            t.prototype.authorize = function(e, n) {
                return t.authorizers = t.authorizers || i.default.getAuthorizers(),
          ...
          , a = function(t) {
                ...
                t.prototype.authorize.call(this, e, function(t, e) {
                    if (!t) {
                        if (void 0 === e.channel_data)
                            return r.default.warn("Invalid auth response for channel '" + i.name + "', expected 'channel_data' field"),
            ...
            e.prototype.handleEvent = function(t, e) {
                ...
                case "pusher_internal:subscription_succeeded":
                    ...
                    this.subscribed = !0,
                    this.subscriptionCancelled ? this.pusher.unsubscribe(this.name) : (this.members.onSubscription(e),
    ...
    , function(t, e, n) {
        ...
        var i = this && this.__extends || function(t, e) {
          ...
          , a = function(t) {
            ...
            ,
            e.prototype.handleEvent = function(t, e) {
                0 === t.indexOf("pusher_internal:") ? "pusher_internal:subscription_succeeded" === t && (this.subscriptionPending = !1,
                this.subscribed = !0,
                this.subscriptionCancelled ? this.pusher.unsubscribe(this.name) : this.emit("pusher:subscription_succeeded", e)) : this.emit(t, e)
            }
            ,
            ...
            e.prototype.startConnecting = function() {
                var t = this
                  , e = function(n, i) {
                    ...
                    t.handshakeCallbacks[i.action](i))
                };
        ...
        var o = n(9)
          ...
          , s = function() {
            ...
            return t.prototype.add = function(t, e) {
                return this.channels[t] || (this.channels[t] = i(t, e)),
                this.channels[t]
            }
            ,
        ...
        var o = n(42)
          ...
          , c = function() {
            ...
            t.prototype.connect = function(t, e) {
                var n = this;
                if (!this.isSupported())
                    return i(new s.UnsupportedStrategy, e);
                if (this.priority < t)
                    return i(new s.TransportPriorityTooLow, e);
                var r = !1
                  , c = this.transport.createConnection(this.name, this.priority, this.options.key, this.options)
                  , u = null
                  , l = function() {
                    c.unbind("initialized", l),
                    c.connect()
                }
                  , h = function() {
            ...
            t.prototype.connect = function(t, e) {
                var n = this
                  ...
                  , a = function(c, u) {
                    ...
                    n.loop && (o %= i.length),
                    o < i.length ? (r && (r *= 2,
                    n.timeoutLimit && (r = Math.min(r, n.timeoutLimit))),
                    s = n.tryStrategy(i[o], t, {
                        timeout: r,
                        failFast: n.failFast
                    }, a)) : e(!0))
                };
          ...
          , c = function() {
            ...
            t.prototype.connect = function(t, e) {
                return i(this.strategies, t, function(t, n) {
                    return function(i, r) {
                        return n[t].error = i,
                        i ? void (o(n) && e(!0)) : (s.apply(n, function(t) {
            ...
            t.prototype.connect = function(t, e) {
                ...
                var h = a.default.now()
                  , p = c.pop().connect(t, function i(o, u) {
                    o ? (s(n),
                    c.length > 0 ? (h = a.default.now(),
                    p = c.pop().connect(t, i)) : e(o)) : (r(n, u.transport.name, a.default.now() - h),
                    e(null, u))
                });
                return {
                    abort: function() {
