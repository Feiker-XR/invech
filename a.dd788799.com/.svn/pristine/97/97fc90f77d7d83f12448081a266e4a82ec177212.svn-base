...
CREATE DEFINER=`root`@`localhost` PROCEDURE `kanJiang`(IN `_betId` INT, IN `_zjCount` INT, IN `_zjAmount` FLOAT, IN `_kjData` VARCHAR(255), IN `_kset` VARCHAR(255))
BEGIN
