...
//auto_3
//北京pk拾
//$html_data = file_get_contents("http://c.apiplus.net/newly.do?token=8c72e19ff2174223&code=bjpk10&format=json");
$html_data = file_get_contents("http://47.90.17.50/caiji/bjpk10.php");
