...
$sql		=	"select id from bet_match where Match_CoverDate>'".date('Y-m-d H:i:s')."' and match_date!='".date("m-d")."' and (Match_BHo+Match_BAo<>0 or Match_Bdpl+Match_Bxpl<>0) and Match_IsShowb=1 ".$sqlwhere.' order by Match_CoverDate,iPage,match_name,Match_Master,Match_ID,iSn';
