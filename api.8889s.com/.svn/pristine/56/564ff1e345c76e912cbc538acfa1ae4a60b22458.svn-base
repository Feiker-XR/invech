...
class user extends Validate{
    protected $rule = [
        'username' => 'require|length:5,12|alphaNum',
    ...
    protected $message = [
        ...
        'username.length'   =>  '用户名长度必须在5~12之间!',
    ...
    protected $scene  = [
        'check'     =>  ['username'],
        'reg'       =>  ['username','password','repassword',/*'zcturename',*/'qkpwd1','qkpwd2','zcanswer'],
        'login'     =>  ['username','password'],
        'truename'  =>  ['zcturename'],
        'reg_api'       =>  ['username','password',/*'repassword',*/],        
    ];
}