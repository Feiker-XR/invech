...
//$html_data = file_get_contents("http://c.apiplus.net/newly.do?token=8c72e19ff2174223&code=gdklsf&format=json");
$html_data = file_get_contents("http://47.90.17.50/caiji/gdklsf.php");
