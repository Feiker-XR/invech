...
class Lotterybet extends Login{
    ...
    public function _initialize(){
        ...
        if(cache($key)){
            echo '<script type="text/javascript">parent.layer.msg("<font color=red>您投注过于频繁!</font>", {icon: 2});</script>';
            exit();            
        }
        ...
        if(isset($_POST['money'])){
            if(floatval($_POST['money'])<=0){
                echo '<script type="text/javascript">parent.layer.msg("金额参数错误，请重新下注！", 3, 3);</script>';
                exit;
            }
        }
