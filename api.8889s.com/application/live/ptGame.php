...
class ptGame {
    ...
    public static $_BASEURL = 'https://kioskpublicapi.luckyspin88.com';    
    //public static $_SSLCERT = APP_PATH.'/pt/WIN88.pem';
    //public static $_SSLKEY = APP_PATH.'/pt/WIN88.key';
    public static $_SSLCERT = APP_PATH.'/pt/New_GTLCCNYTLE.pem';
    public static $_SSLKEY = APP_PATH.'/pt/New_GTLCCNYTLE.key';
...
file_put_contents(dirname(__FILE__) . '/pt.log', 'url='.$url . "\r\n", FILE_APPEND);        
file_put_contents(dirname(__FILE__) . '/pt.log', $exec . "\r\n", FILE_APPEND);
