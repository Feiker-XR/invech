...
class auto {
    ...
    public function gsf(){
        ...
        $rows  = Db::name('c_auto_1') -> order('qishu desc') ->limit(5) ->select();
        $hm    = $hms = $hmlist = array();
        $is    = 1;
        $qishu = '';
        foreach($rows as $rs){
    ...
    public function cqssc(){
        ...
        foreach($rows as $rs){
            ...
            $mobilelist[$rs['qishu']][] = $rs['ball_1'];
            $mobilelist[$rs['qishu']][] = $rs['ball_2'];
            $mobilelist[$rs['qishu']][] = $rs['ball_3'];
            $mobilelist[$rs['qishu']][] = $rs['ball_4'];
            $mobilelist[$rs['qishu']][] = $rs['ball_5'];
            $is++;
        }
        $arr = array(
            'numbers' => $qishu,
    ...
    public function pk10(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_3') -> order('qishu desc') ->limit(5) -> select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
            ...
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_1']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_2']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_3']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_4']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_5']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_6']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_7']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_8']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_9']);
            $mobilelist[$rs['qishu']][] = $this->BuLing($rs['ball_10']);
	       $is++;
        }
        $arr = array(
            'numbers' => $qishu,
    ...
    public function xyft(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_9') -> order('qishu desc') ->limit(5) -> select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
    ...
    public function xjssc(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_7') -> order('qishu desc') ->limit(5) -> select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
    ...
    public function csf(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_4') -> order('qishu desc') ->limit(5) -> select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
    ...
    public function gxsf(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_5') -> order('qishu desc') ->limit(5) -> select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
    ...
    public function jsk3(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_6') -> order('qishu desc') ->limit(5) -> select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
    ...
    public function f2ssc(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_2fc') -> order('qishu desc') ->limit(5) ->select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
    ...
    public function f5ssc(){
        include_once APP_PATH .'../common/lottery/auto_class.php';
        $rows = Db::name('c_auto_5fc') -> order('qishu desc') ->limit(5) ->select();
        $hm = $hms = $hmlist = array();
        $is = 1;
        $qishu = '';
        foreach($rows as $rs){
