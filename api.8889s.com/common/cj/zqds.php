...
$msg_num=0;
if($pages==0){
	$data=theif_data($webdb["datesite"],$webdb["cookie"],'msg','r',$langx,$pages);
	//echo $data;;
...
if($pages<$t_page){
	$data=theif_data($webdb["datesite"],$webdb["cookie"],'FT','r',$langx,$pages);
	file_put_contents(dirname(__FILE__)."/zqds.txt",$data);
