		...
		if(window_lsm.length > 2000){
			if(window.XMLHttpRequest){ //Mozilla, Safari, IE7 
				if(!window.ActiveXObject){ // Mozilla, Safari, 
					JqueryDialog.Open('足球早餐单式', '/index.php/sport/dialog.html?lsm='+window_lsm, 600, window_hight);
				}else{ //IE7
					JqueryDialog.Open('足球早餐单式', '/index.php/sport/dialog.html?lsm=zqzcds', 600, window_hight);
				}
			}else{ //IE6
				JqueryDialog.Open('足球早餐单式', '/index.php/sport/dialog.html?lsm=zqzcds', 600, window_hight);
			}
