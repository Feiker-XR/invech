...
function loaded(league,thispage,p){
	...
	$.getJSON("ftz_shangbanchang_data.php?leaguename="+league+"&CurrPage="+thispage+"&callback=?",function(json){
...
$(document).ready(function(){
	$("#xzls").click(function(){ //选择联赛
		JqueryDialog.Open('足球早餐上半场', 'dialog.php?lsm='+window_lsm, 600, window_hight);
	});
});