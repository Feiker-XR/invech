...
if('leon' == $_SERVER['USERNAME']){
    $date = '2017-08-21';
    $mDate = '08-21';     
}
$sql = "select MB_Inball,TG_Inball,MB_Inball_HR,TG_Inball_HR,Match_Master,match_name,Match_Guest,Match_ID from bet_match where `Match_Date` ='$mDate' and (MB_Inball>=0 or MB_Inball_HR>=0 or (MB_Inball='-1' and TG_Inball='-1')) and match_js!='1' order by ID";
echo $sql,"\r\n";
