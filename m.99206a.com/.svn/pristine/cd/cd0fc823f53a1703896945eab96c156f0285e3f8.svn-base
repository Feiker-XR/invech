...
//	listenWindow()
	...
	$.ajax({
		...
		success : function(data) {
			...
			$.post("/ajaxleft/bet_match.html",{ball_sort:typename_in,match_id:match_id_in,touzhuxiang:touzhuxiang_in,point_column:point_column_in,ben_add:ben_add_in,is_lose:is_lose_in,xx:xx_in,touzhutype:touzhutype,rand:Math.random()},function (data){
				bet(data);
				//$('#bet_box').fadeIn();
			});
