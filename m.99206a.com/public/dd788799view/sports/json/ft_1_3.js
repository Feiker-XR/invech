...
function loaded(league,thispage,p){
	...
	$.getJSON("/sport/FT_1_3.html?leaguename="+league+"&CurrPage="+thispage+"&callback=?",function(json){
...
$(document).ready(function(){
	$("#xzls").click(function(){ //选择联赛
		JqueryDialog.Open('足球半全场', '/sport/dialog.html?lsm='+window_lsm, 600, window_hight);
	});
});