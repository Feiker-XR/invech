...
$(document).ready(function(){
	$("#xzls").click(function(){ //选择联赛
		//JqueryDialog.Open('排球单式', 'dialog.php?lsm='+window_lsm, 300, window_hight);
        $('.curtions').show();
