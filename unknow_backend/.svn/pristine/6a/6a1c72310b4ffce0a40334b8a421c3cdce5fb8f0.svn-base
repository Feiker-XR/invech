...
$urlx = base64_encode("http://www.1396cp.com/gdkl10/kaijiang/");
...
if($m){
	...
	if($m1){
		...
		foreach ($m1[0] as $v) {
			...
			$preg_nums = "#<td[^>]*class=\"nums\"[^>]*>.*[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*<span[^>]*class=[\"\']no[0-9]+[\"\']>([0-9]+)</span>[^>]*</td>#";
