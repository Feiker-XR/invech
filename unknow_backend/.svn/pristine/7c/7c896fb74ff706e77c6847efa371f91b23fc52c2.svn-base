...
namespace app\live;
class ptGame {
    public static $_BASEURL = 'https://kioskpublicapi.luckyspin88.com';//'https://kioskpublicapi.grandmandarin88.com';
    //public static $_SSLCERT = APP_PATH.'/pt/WIN88.pem';
    //public static $_SSLKEY = APP_PATH.'/pt/WIN88.key';
    public static $_SSLCERT = APP_PATH.'/pt/New GTLCCNYTLE.pem';
    public static $_SSLKEY = APP_PATH.'/pt/New GTLCCNYTLE.key';
