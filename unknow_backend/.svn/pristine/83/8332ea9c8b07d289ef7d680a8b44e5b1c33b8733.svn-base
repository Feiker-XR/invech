...
//	}
	...
	$.ajax({
		...
		success : function(data) {
			if (data.islogin == 1) {
				$.post("/index.php/ajaxleft/lq_match.html",{ball_sort:typename_in,match_id:match_id_in,touzhuxiang:touzhuxiang_in,point_column:point_column_in,ben_add:ben_add_in,xx:xx_in,touzhutype:touzhutype,rand:Math.random()},function (data){
