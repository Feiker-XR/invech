...
function loaded(league,thispage,p){
	...
	$.getJSON("/index.php/sport/FT_1_4.html?leaguename="+league+"&CurrPage="+thispage+"&callback=?",function(json){
...
$(document).ready(function(){
	$("#xzls").click(function(){ //选择联赛
		JqueryDialog.Open('足球波胆', '/index.php/sport/dialog.html?lsm='+window_lsm, 600, window_hight);
	});
});