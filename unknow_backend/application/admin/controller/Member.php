	...
	public function hecha(){
	    ...
	    if($username){
	        ...
	        if($rows){
	            ...
	            */
	            $sql_m		=	"select sum(case when type=1 or type = 100 then m_value else 0 end) as ck,sum(case when type=2 or type=200 then m_value else 0 end) as zs,sum(case when type=3 or type=600 then m_value else 0 end) as fs,sum(case when type=4 then m_value else 0 end) as qt,sum(case when type=11 or type=255 or type=900 then m_value else 0 end) as qk,sum(case when type=12 or type=120 then m_value else 0 end) as kk from k_money where uid=".$rows["uid"]." and status=1";	            
