...
//              playRing(1);
			...
			var auto_top = '<table width="100%" border="0" cellspacing="1" cellpadding="0" class="clbian"><tr class="clbian_tr_title"><td colspan="2"><a href="ssc_list.php" target="_blank">更多开奖结果</a></td></tr></tr>';
