...
//盘口信息
function loadinfo(){
	$.get("/index.php/lottery/odds/gid/xsc/", function(data)
		{
			if(data.opentime>0 && data.endtime > 0){
				...
				alert('当前彩票已经封盘，请稍后再进行下注！\r新疆时时彩开盘时间为：每日10:00 - 次日02:00');
				return false;
			}
		}, "json");
}
...
//更新开奖号码
function auto(ball){
	$.get("/index.php/lottery/auto/gid/xjssc", {ball : ball}, function(data)
		{
...
//              playRing(1);
			...
			var auto_top = '<table width="100%" border="0" cellspacing="1" cellpadding="0" class="clbian"><tr class="clbian_tr_title"><td colspan="2"><a href="/openlist/xjssc" target="_blank">更多开奖结果</a></td></tr></tr>';
		...
		$.post("/index.php/lottery/changlong.html",{code:'新疆时时彩'},function(data){
		if(data == false){
