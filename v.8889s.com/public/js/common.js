...
function changeFrameHeight(){
	...
	iframeId.css("height",bodyClientH + 200)
	alert("nihao")
}	
...
$(function(){
	$("#J_broadcast").click(function(){
		window.open('/index/noticle.html','newwindow','menubar=no,status=yes,scrollbars=yes,top=150,left=408,toolbar=no,width=575,height=550')
	});    	   
});
// 圖片 淡出效果
