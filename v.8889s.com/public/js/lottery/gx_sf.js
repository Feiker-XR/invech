...
//盘口信息
function loadinfo(){
	$.get("/index.php/lottery/odds/gid/gxsf/", function(data)
		{
...
//更新开奖号码
function auto(ball){
	$.get("/index.php/lottery/auto/gid/gxsf", {ball : ball}, function(data)
		{
...
//              playRing(1);
		...
		$.post("/index.php/lottery/changlong.html",{code:'广西快乐十分'},function(data){
		if(data == false){
